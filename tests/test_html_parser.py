...
<body>
    <header>
        <h1 id="main-title">MCP Code Intelligence Documentation</h1>
    ...
    <main id="content">
        ...
        <section id="getting-started">
            ...
            <p>To start using MCP Code Intelligence, first initialize your project directory. This creates the necessary configuration and index structure.</p>
