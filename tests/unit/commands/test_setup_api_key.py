...
from mcp_code_intelligence.cli.commands.setup import (
    _obfuscate_api_key,
...
def mock_project_root(tmp_path):
    ...
    config_dir = tmp_path / ".mcp-code-intelligence"
...
class TestSetupOpenRouterApiKey:
    ...
    @patch("mcp_code_intelligence.cli.output.console")
    ...
    @patch("mcp_code_intelligence.cli.output.console")
    @patch("mcp_code_intelligence.core.config_utils.save_openrouter_api_key")
    ...
    @patch("mcp_code_intelligence.cli.output.console")
    @patch("mcp_code_intelligence.core.config_utils.get_openrouter_api_key")
    @patch("mcp_code_intelligence.core.config_utils.delete_openrouter_api_key")
...
class TestApiKeySetupIntegration:
    ...
    def test_full_workflow_no_key_to_saved(
        ...
        from mcp_code_intelligence.core.config_utils import get_openrouter_api_key

        config_dir = mock_project_root / ".mcp-code-intelligence"
