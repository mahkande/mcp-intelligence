...
def test_segfault_handler_message():
    ...
    assert "mcp-code-intelligence reset index --force" in error_output
    assert "mcp-code-intelligence index" in error_output
...
def test_segfault_handler_suggestions():
    ...
    assert "pip install -U mcp-code-intelligence" in error_output
    assert "github.com/bobmatnyc/mcp-code-intelligence" in error_output
...
def test_faulthandler_enabled():
    ...
    import mcp_code_intelligence.cli.main  # noqa: F401
