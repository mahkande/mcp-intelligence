...
from mcp_code_intelligence.analysis.storage.metrics_store import ProjectSnapshot
from mcp_code_intelligence.cli.commands.status import (
...
class TestStatusMetricsCommand:
    ...
    def test_status_metrics_empty_database(self, tmp_path):
        ...
        metrics_dir = tmp_path / ".mcp-code-intelligence"
        metrics_dir.mkdir()
