...
from mcp_code_intelligence.core.database import (
...
class TestPooledChromaVectorDatabase:
    ...
    async def test_sqlite_corruption_detection(self, temp_dir, mock_embedding_function):
        ...
        from mcp_code_intelligence.core.exceptions import DatabaseInitializationError
        ...
        try:
            ...
            error_msg = str(e)
            assert "mcp-code-intelligence reset" in error_msg
    ...
    async def test_rust_panic_recovery_failure(self, temp_dir, mock_embedding_function):
        ...
        from mcp_code_intelligence.core.exceptions import DatabaseError
        ...
        with patch("chromadb.PersistentClient") as mock_client:
            ...
            assert "mcp-code-intelligence reset" in str(exc_info.value)
