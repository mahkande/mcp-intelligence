...
def reporter() -> SARIFReporter:
    ...
    return SARIFReporter(
        tool_name="MCP Code Intelligence Test",
        tool_version="1.0.3",
        tool_uri="https://github.com/bobmatnyc/mcp-code-intelligence",
    )
...
class TestSARIFReporter:
    ...
    def test_generate_sarif_structure(
        ...
        assert tool["name"] == "MCP Code Intelligence Test"
        assert tool["version"] == "1.0.3"
        assert (
            tool["informationUri"] == "https://github.com/bobmatnyc/mcp-code-intelligence"
        )
