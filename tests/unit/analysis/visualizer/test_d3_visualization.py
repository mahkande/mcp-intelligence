...
from mcp_code_intelligence.analysis.visualizer import (
    AnalysisExport,
    CyclicDependency,
    DependencyEdge,
    DependencyGraph,
...
from mcp_code_intelligence.analysis.visualizer.d3_data import (
    D3Edge,
    D3Node,
...
class TestEnhancedD3Node:
    ...
    def test_node_with_full_details(self, sample_file_detail: FileDetail) -> None:
        ...
        from mcp_code_intelligence.analysis.visualizer.d3_data import _create_node
