...
class TestCLICommands:
    ...
    def setup_project_dir(self, temp_project_dir):
        ...
        # Clean up any existing .mcp-code-intelligence directory to avoid ChromaDB corruption
        mcp_dir = temp_project_dir / ".mcp-code-intelligence"
        if mcp_dir.exists():
    ...
    def test_init_command(self, cli_runner, temp_project_dir):
        ...
        config_file = temp_project_dir / ".mcp-code-intelligence" / "config.json"
    ...
    def test_init_command_without_force(self, cli_runner, temp_project_dir):
        ...
        with patch(
            "mcp_code_intelligence.cli.commands.init.confirm_action"
        ) as mock_confirm:
    ...
    def test_index_command(self, cli_runner, temp_project_dir):
        ...
        index_db = temp_project_dir / ".mcp-code-intelligence" / "chroma.sqlite3"
