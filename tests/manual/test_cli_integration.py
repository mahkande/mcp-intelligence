...
def main():
    """Run all tests."""
    print("\n" + "=" * 60)
    print("MCP Code Intelligence - Claude CLI Integration Tests")
    print("=" * 60)
    ...
    try:
        ...
        print("\nNext Steps:")
        print("  1. Run 'mcp-code-intelligence setup --verbose' to test full workflow")
        print("  2. Run 'mcp-code-intelligence install claude-code' to test install")
