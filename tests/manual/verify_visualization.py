...
def verify_visualization():
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(
            path="/Users/masa/Projects/mcp-code-intelligence/tests/manual/screenshot_initial.png",
            full_page=True,
        )
        ...
        page.screenshot(
            path="/Users/masa/Projects/mcp-code-intelligence/tests/manual/screenshot_final.png",
            full_page=True,
        )
        ...
        with open(
            "/Users/masa/Projects/mcp-code-intelligence/tests/manual/verification_report.json",
            "w",
        ) as f:
