...
async def test_glob_filtering():
    ...
    if not project_manager.is_initialized():
        print("❌ Project not initialized. Run 'mcp-code-intelligence init' first.")
        return
    ...
    print("  mcp-code-intelligence search --files '*.py' 'function'")
    print("  mcp-code-intelligence search --files 'src/*.py' 'database'")
    print("  mcp-code-intelligence search --files 'search.py' 'query'")
