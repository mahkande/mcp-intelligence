...
async def investigate():
    async with async_playwright() as p:
        ...
        await page.screenshot(
            path="/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/visualization/debug-fullpage.png",
            full_page=True,
        )
        ...
        if graph_container:
            await graph_container.screenshot(
                path="/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/visualization/debug-graph-area.png"
            )
        ...
        print("=" * 80)
        print("\nCheck the screenshots in .mcp-code-intelligence/visualization/")
