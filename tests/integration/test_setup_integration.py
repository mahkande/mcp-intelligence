...
from mcp_code_intelligence.cli.commands.setup import _run_smart_setup
...
class TestSetupCompleteWorkflow:
    ...
    async def test_setup_complete_workflow(self, python_project, mock_typer_context):
        ...
        with (
            patch(
                "mcp_code_intelligence.cli.commands.setup.detect_all_platforms"
            ) as mock_detect,
            patch(
                "mcp_code_intelligence.cli.commands.setup.check_claude_cli_available"
            ) as mock_check_claude,
            patch(
                "mcp_code_intelligence.cli.commands.setup.check_uv_available"
            ) as mock_check_uv,
            patch("subprocess.run") as mock_subprocess,
            patch("mcp_code_intelligence.cli.commands.index.run_indexing") as mock_index,
        ):
            ...
            config_path = python_project / ".mcp-code-intelligence" / "config.json"
            ...
            assert ".mcp-code-intelligence/" in gitignore_content
    ...
    async def test_setup_with_existing_project(
        ...
        with (
            patch(
                "mcp_code_intelligence.cli.commands.setup.detect_installed_platforms"
            ) as mock_detect,
            patch(
                "mcp_code_intelligence.cli.commands.setup.check_claude_cli_available"
            ) as mock_check_claude,
    ...
    async def test_setup_multi_language_project(
        ...
        with (
            ...
            patch(
                "mcp_code_intelligence.cli.commands.setup.configure_platform"
            ) as mock_configure,
            patch("mcp_code_intelligence.cli.commands.index.run_indexing") as mock_index,
        ):
            mock_detect.return_value = {}
            ...
            config_path = mixed_project / ".mcp-code-intelligence" / "config.json"
