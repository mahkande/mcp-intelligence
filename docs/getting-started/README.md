# Getting Started with MCP Code Intelligence

Welcome! This guide will help you get up and running with MCP Code Intelligence in minutes.

## 📋 What You'll Learn

This section covers:
- **[Installation](installation.md)** - Install and deploy MCP Code Intelligence
...
### 1. Installation
Start here if you haven't installed MCP Code Intelligence yet.
...
### 2. Configuration
Learn how to configure MCP Code Intelligence for your project.
...
- **Questions**: Visit [GitHub Discussions](https://github.com/bobmatnyc/mcp-code-intelligence/discussions)
- **Bugs**: Report on [GitHub Issues](https://github.com/bobmatnyc/mcp-code-intelligence/issues)
