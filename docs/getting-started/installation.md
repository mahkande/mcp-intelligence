...
Complete guide to installing and setting up mcp-code-intelligence in your project.
...
pip install mcp-code-intelligence==0.12.6
...
- **Command used**: `mcp` (not `mcp-code-intelligence` for consistency)
- **Server module**: `python -m mcp_code_intelligence.mcp.server`
...
- **`.mcp-code-intelligence/`** - Vector database and configuration
...
- **`.mcp-code-intelligence/`** directory containing:
...
mcp-code-intelligence init --extensions .py,.js,.ts --embedding-model sentence-transformers/all-MiniLM-L6-v2
...
mcp-code-intelligence index /path/to/code
...
# Upgrade via UV
uv add mcp-code-intelligence --upgrade
```
...
- **GitHub Issues**: [Report bugs and request features](https://github.com/bobmatnyc/mcp-code-intelligence/issues)
- **GitHub Discussions**: [Ask questions and share ideas](https://github.com/bobmatnyc/mcp-code-intelligence/discussions)
...
- mcp-code-intelligence version (`mcp-code-intelligence version`)
