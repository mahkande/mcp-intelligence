...
Step-by-step guides for common tasks and workflows with MCP Code Intelligence.
...
Integrate MCP Code Intelligence with AI tools like Claude Desktop, Cursor, and more.
...
- **[Getting Started](../getting-started/README.md)** - New to MCP Code Intelligence? Start here
...
- **Community**: [GitHub Discussions](https://github.com/bobmatnyc/mcp-code-intelligence/discussions)
- **Support**: [GitHub Issues](https://github.com/bobmatnyc/mcp-code-intelligence/issues)
