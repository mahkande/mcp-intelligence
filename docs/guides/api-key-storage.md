...
This guide explains how to securely store and manage your OpenRouter API key for the `mcp-code-intelligence chat` command.
...
2. Local config file `.mcp-code-intelligence/config.json`
...
mcp-code-intelligence setup --save-api-key

# Or manually edit config file
# File: .mcp-code-intelligence/config.json
...
- `.mcp-code-intelligence/` directory is gitignored by default
...
# OR
#    Source: Config file (/path/to/.mcp-code-intelligence/config.json)
```
...
# Or delete the entire .mcp-code-intelligence/ directory and re-init
```
...
mcp-code-intelligence chat "your question"
...
# Check config file
cat .mcp-code-intelligence/config.json | grep openrouter_api_key
```
...
```bash
chmod 700 .mcp-code-intelligence/
chmod 600 .mcp-code-intelligence/config.json
```
...
python -m json.tool .mcp-code-intelligence/config.json
```

### Want to use different keys for different projects

**Solution:**
Use the config file approach - each project has its own `.mcp-code-intelligence/config.json`:

```bash
cd project1/
mcp-code-intelligence setup --save-api-key  # Enter key for project 1

cd ../project2/
mcp-code-intelligence setup --save-api-key  # Enter key for project 2
```
...
- Commit `.mcp-code-intelligence/config.json` with API keys to git
...
mcp-code-intelligence chat "where is the search function?"
...
- GitHub Issues: https://github.com/yourusername/mcp-code-intelligence/issues
- Documentation: https://github.com/yourusername/mcp-code-intelligence/docs
