...
The MCP Code Intelligence server now includes automatic file watching capabilities. When enabled, the server monitors your project directory for changes and automatically updates the search index in real-time.
...
mcp-code-intelligence mcp install --watch
```
...
mcp-code-intelligence mcp install --no-watch
```
...
- The search index directory (`.mcp-code-intelligence`)

## Performance Considerations

### Benefits
- **Real-time Updates**: Search results always reflect the current state of your code
- **No Manual Reindexing**: Eliminates the need to run `mcp-code-intelligence index` after changes
