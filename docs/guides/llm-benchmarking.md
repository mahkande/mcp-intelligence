...
2. **Indexed Project**: Run `mcp-code-intelligence init` and `mcp-code-intelligence index` first
...
- Check your index: `mcp-code-intelligence status`
- Reindex if needed: `mcp-code-intelligence index`
- Try broader queries
...
- [LLM Client Source](../../src/mcp_code_intelligence/core/llm_client.py)
