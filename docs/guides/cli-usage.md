...
MCP Code Intelligence now supports **8 programming languages** with full semantic search capabilities:
...
mcp-code-intelligence search "contact form section"
mcp-code-intelligence search "navigation menu structure"
mcp-code-intelligence search "pricing table layout"

# PHP - Laravel Controller
mcp-code-intelligence search "user authentication controller"

# Ruby - Rails Model
mcp-code-intelligence search "activerecord validation"

# Dart - Flutter Widget
mcp-code-intelligence search "stateful widget with state management"

# Python - Django View
mcp-code-intelligence search "django view with authentication"

# JavaScript - React Component
mcp-code-intelligence search "react component with hooks"

# TypeScript - Generic Interface
mcp-code-intelligence search "generic type interface"
```
...
mcp-code-intelligence search "database model with relationships"

# Find API endpoints in any language
mcp-code-intelligence search "REST API endpoint"
```

## Rich Help System

The mcp-code-intelligence CLI features an industry-standard help system with progressive disclosure, organized panels, and comprehensive examples.
...
Next steps:
  • Search your code: mcp-code-intelligence search "your query"
  • View project status: mcp-code-intelligence status
  • Configure auto-indexing: mcp-code-intelligence auto-index setup
```
...
Recovery:
  1. Run: mcp-code-intelligence install
  2. Or: mcp-code-intelligence init && mcp-code-intelligence index
```

## "Did You Mean" Command Suggestions

The mcp-code-intelligence CLI includes intelligent command suggestions to help users when they make typos or use similar commands.
...
```bash
# MCP subcommands
$ mcp-code-intelligence mcp instal
No such command 'instal'. Did you mean 'install'?

# Search subcommands (legacy)
$ mcp-code-intelligence search-legacy simlar
...
MCP Code Intelligence provides flexible configuration options to customize indexing behavior and search settings.
