...
Complete guide to using semantic search effectively in mcp-code-intelligence.
...
# Search for patterns
mcp-code-intelligence search "error handling for API calls"
```
...
mcp-code-intelligence search "function that validates email addresses"
mcp-code-intelligence search "class for handling user authentication"
mcp-code-intelligence search "code that connects to PostgreSQL database"

# ❌ Less effective queries (too vague)
mcp-code-intelligence search "email"
mcp-code-intelligence search "database"
```
...
```bash
# Vague
mcp-code-intelligence search "user"

# Better
mcp-code-intelligence search "user registration with email verification"
```

#### Include Context
```bash
# Generic
mcp-code-intelligence search "parse"

# Contextual
mcp-code-intelligence search "parse JSON configuration files"
```

#### Describe Functionality
```bash
# Keyword-based
mcp-code-intelligence search "jwt token"

# Functionality-based
mcp-code-intelligence search "function that generates and validates JWT tokens"
```

#### Use Technical Terms
```bash
# Include relevant terminology
mcp-code-intelligence search "React hook for fetching data with retry logic"
mcp-code-intelligence search "Django model with many-to-many relationship"
mcp-code-intelligence search "async function that handles WebSocket connections"
```
...
```bash
mcp-code-intelligence search "your query here"
```
...
mcp-code-intelligence search --similar /path/to/file.py --limit 15
```
...
mcp-code-intelligence search "API endpoint" --context "REST,authentication,error-handling"
```
...
# Show more results
mcp-code-intelligence search "authentication" --limit 25

# Show all results
mcp-code-intelligence search "authentication" --limit 100
```
...
mcp-code-intelligence search "authentication" --language javascript

# Multiple languages (if supported)
mcp-code-intelligence search "API endpoint" --language python,typescript
```
...
# React components
mcp-code-intelligence search "authentication" --file-extension .tsx

# Multiple extensions
mcp-code-intelligence search "config" --file-extension .json,.yaml
```
...
```bash
# Functions only
mcp-code-intelligence search "authentication" --function-name "*"

# Specific function name pattern
mcp-code-intelligence search "authentication" --function-name "validate*"

# Classes only
mcp-code-intelligence search "authentication" --class-name "*"

# Specific class name pattern
mcp-code-intelligence search "authentication" --class-name "*Auth*"
```
...
mcp-code-intelligence search "authentication" --threshold 0.9

# More permissive (0.6+)
mcp-code-intelligence search "authentication" --threshold 0.6
```
...
mcp-code-intelligence search "authentication" \
  --language python \
  --function-name "*" \
  --threshold 0.8 \
  --limit 5
...
mcp-code-intelligence search "button component" \
  --file-extension .tsx \
  --limit 10 \
  --threshold 0.75
```
...
mcp-code-intelligence search favorites add "authentication logic"

# List favorites
mcp-code-intelligence search favorites

# Remove favorite
mcp-code-intelligence search favorites remove "authentication logic"

# Search from favorites
mcp-code-intelligence search favorites run "authentication logic"
```
...
mcp-code-intelligence search "user authentication"

# API clients in any language
mcp-code-intelligence search "HTTP client with retry logic"
```
...
mcp-code-intelligence search "HTTP request handler for user registration"

# Models/Entities
mcp-code-intelligence search "database model for user account"

# Services/Business Logic
mcp-code-intelligence search "service that processes payment transactions"

# Utilities/Helpers
mcp-code-intelligence search "utility function for date formatting"
```
...
```bash
# Design patterns
mcp-code-intelligence search "singleton pattern implementation"
mcp-code-intelligence search "factory method for creating database connections"
mcp-code-intelligence search "observer pattern for event handling"

# Best practices
mcp-code-intelligence search "async function with proper error handling"
mcp-code-intelligence search "database transaction with rollback"
mcp-code-intelligence search "rate limiting middleware"
```
...
```bash
# React
mcp-code-intelligence search "React hook for form validation"
mcp-code-intelligence search "React context provider for authentication"

# Django
mcp-code-intelligence search "Django view with permission checking"
mcp-code-intelligence search "Django model with custom manager"

# Express
mcp-code-intelligence search "Express middleware for authentication"
mcp-code-intelligence search "Express route with validation"

# Laravel
mcp-code-intelligence search "Laravel controller with validation rules"

# Rails
mcp-code-intelligence search "Rails ActiveRecord scope for filtering"

# Flutter
mcp-code-intelligence search "Flutter stateful widget with animation"
```
...
```bash
# Error handling
mcp-code-intelligence search "error handling for network failures"
mcp-code-intelligence search "try-catch block for database operations"

# Edge cases
mcp-code-intelligence search "null pointer check before accessing"
mcp-code-intelligence search "validation for empty string input"

# Logging
mcp-code-intelligence search "logging for debugging API calls"
```
...
mcp-code-intelligence search --similar src/utils/format_date.py

# Large functions (for splitting)
mcp-code-intelligence search "function with multiple responsibilities"

# Code smells
mcp-code-intelligence search "function with many parameters"
mcp-code-intelligence search "deeply nested conditional logic"
```
...
2. **Make query more specific**
   ```bash
   # Instead of "user"
   mcp-code-intelligence search "user registration with email validation"
   ```

3. **Add filters**
   ```bash
   mcp-code-intelligence search "authentication" --language python --limit 5
   ```
