...
mcp-code-intelligence analyze --changed-only --language python
```
...
mcp-code-intelligence analyze --baseline HEAD~5
```
...
mcp-code-intelligence analyze --changed-only --path src/core

# Changed files vs main with JSON output
mcp-code-intelligence analyze --baseline main --json

# Quick mode on changed files
mcp-code-intelligence analyze --changed-only --quick
```
...
mcp-code-intelligence analyze --changed-only --fail-on-smell --severity-threshold warning
...
mcp-code-intelligence analyze --changed-only --top 5
```
...
mcp-code-intelligence analyze --baseline main --format sarif --output review.sarif
```
...
git diff --cached --name-only | xargs -I {} mcp-code-intelligence analyze --path {}
...
mcp-code-intelligence analyze --baseline HEAD~10

# Compare specific branch vs production
git checkout feature/optimization
mcp-code-intelligence analyze --baseline production --json
```
...
mcp-code-intelligence analyze --path <file>
```
