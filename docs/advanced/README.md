...
Advanced guides for power users, performance tuning, troubleshooting, and extending MCP Code Intelligence.
...
Optimize MCP Code Intelligence for your specific use case.
...
#### [Extending MCP Code Intelligence](extending.md)
...
- **Questions**: [GitHub Discussions](https://github.com/bobmatnyc/mcp-code-intelligence/discussions)
- **Bug Reports**: [GitHub Issues](https://github.com/bobmatnyc/mcp-code-intelligence/issues)
- **Feature Requests**: [GitHub Discussions](https://github.com/bobmatnyc/mcp-code-intelligence/discussions)
