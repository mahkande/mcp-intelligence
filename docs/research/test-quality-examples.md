...
**Date:** 2026-01-12
**Purpose:** Real examples from mcp-code-intelligence codebase showing good and bad test patterns
...
class TestAutoDetectProjectRoot:
    ...
    def test_detect_with_mcp_code_intelligence_directory(self, tmp_path: Path):
        """Should detect project root via .mcp-code-intelligence directory."""
        # Arrange
        (tmp_path / ".mcp-code-intelligence").mkdir()
    ...
    def test_detect_fallback_to_current_directory(self, tmp_path: Path):
        ...
        # Arrange - No .git or .mcp-code-intelligence
...
async def test_analyze_basic_query(self, mock_project_root, mock_llm_client):
    ...
    with (
        patch("mcp_code_intelligence.core.llm_client.LLMClient") as mock_llm_client,
        patch("mcp_code_intelligence.core.project.ProjectManager") as mock_project_manager,
        patch("mcp_code_intelligence.core.config_utils.get_openai_api_key") as mock_openai_key,
        patch("mcp_code_intelligence.core.config_utils.get_openrouter_api_key") as mock_openrouter_key,
        patch("mcp_code_intelligence.parsers.registry.ParserRegistry") as mock_parser_registry,
        patch("mcp_code_intelligence.analysis.ProjectMetrics") as mock_project_metrics,
        patch("mcp_code_intelligence.analysis.interpretation.EnhancedJSONExporter") as mock_exporter,
    ):
        # ... complex mock setup ...
        pass
```
...
async def main():
    ...
    print("🚀 Testing MCP Code Intelligence...")
