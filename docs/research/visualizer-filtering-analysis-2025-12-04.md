...
**Entry Point:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize.py`
...
**Export Command:**
```bash
mcp-code-intelligence visualize export [OPTIONS]
```
...
**Serve Command:**
```bash
mcp-code-intelligence visualize serve [OPTIONS]
```
...
**File:** `/Users/masa/Projects/mcp-code-intelligence/chunk-graph.json`
**Size:** 22 MB
**Nodes:** 7,015
**Links:** 7,006
...
From codebase analysis (`src/mcp_code_intelligence/parsers/*.py`):
...
- Documentation-heavy projects (like mcp-code-intelligence) have many .md files
...
mcp-code-intelligence visualize export --exclude-types text,comment,docstring

# Include only code structure
mcp-code-intelligence visualize export --include-types function,class,method,module
```
...
mcp-code-intelligence visualize export --max-depth 2
```
...
```bash
# Only Python files
mcp-code-intelligence visualize export --languages python

# Multiple languages
mcp-code-intelligence visualize export --languages python,javascript,typescript
```
...
```bash
# Limit to 500 nodes
mcp-code-intelligence visualize export --max-nodes 500
```
...
mcp-code-intelligence visualize export --file "src/**/*.py"

# Enhanced: multiple patterns
mcp-code-intelligence visualize export --file "src/**/*.py" --file "lib/**/*.js"

# Enhanced: exclude patterns
mcp-code-intelligence visualize export --exclude-file "**/*.md" --exclude-file "tests/**"
```
...
def export(
    ...
    Examples:
        ...
        mcp-code-intelligence visualize export

        # Code only (recommended)
        mcp-code-intelligence visualize export --code-only

        # Small graph for fast loading
        mcp-code-intelligence visualize export --small

        # Python-specific analysis
        mcp-code-intelligence visualize export --language python --exclude-type text

        # Custom filtering
        mcp-code-intelligence visualize export --exclude-type text,comment --max-depth 3 --max-nodes 1000
    """
```

### 5.2 Code Changes Required

**File:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize.py`
...
**Primary File:**
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize.py`
...
2. **Validate Solution:**
   ```bash
   # Test command
   mcp-code-intelligence visualize export --code-only -o test-graph.json

   # Verify size
   ls -lh test-graph.json  # Should be ~6MB (down from 22MB)

   # Test rendering
   mcp-code-intelligence visualize serve --graph test-graph.json
   ```
...
```bash
# Test presets
mcp-code-intelligence visualize export --code-only -o test1.json
mcp-code-intelligence visualize export --small -o test2.json

# Test filters
mcp-code-intelligence visualize export --exclude-type text --max-nodes 500 -o test3.json
mcp-code-intelligence visualize export --language python --code-only -o test4.json
...
# Specific language
mcp-code-intelligence visualize export --language python --code-only
...
mcp-code-intelligence visualize export
mcp-code-intelligence visualize serve
...
mcp-code-intelligence visualize export --exclude-type text --exclude-type comment

# 6. Include only specific types
mcp-code-intelligence visualize export --include-type function --include-type class
...
**Files Analyzed:**
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize.py` (1,475 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/models.py` (295 lines)
- `/Users/masa/Projects/mcp-code-intelligence/chunk-graph.json` (22 MB)
- Various parser files in `src/mcp_code_intelligence/parsers/`
