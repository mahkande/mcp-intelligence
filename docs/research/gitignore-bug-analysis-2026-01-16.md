...
The gitignore implementation in `src/mcp_code_intelligence/utils/gitignore.py` has a critical bug that prevents files inside ignored directories from being excluded during indexing. When a `.gitignore` contains `node_modules/`, the directory itself is correctly ignored, but **files inside** `node_modules/` (like `node_modules/package.json` or `acidigital-rebuild/node_modules/file.js`) are **not** being ignored.
...
**Indexing Pipeline:**
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/indexer.py`
...
**Gitignore Parser:**
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/utils/gitignore.py`
...
**Configuration:**
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/config/settings.py`
...
**File:** `src/mcp_code_intelligence/utils/gitignore.py`
...
cd /Users/masa/Projects/mcp-code-intelligence
mcp-code-intelligence index /tmp/gitignore-test

# 3. Verify only src/index.js is indexed
mcp-code-intelligence stats /tmp/gitignore-test
...
| File | Lines | Role |
|------|-------|------|
| `src/mcp_code_intelligence/utils/gitignore.py` | 44-98 | **BUG LOCATION** - Pattern matching |
| `src/mcp_code_intelligence/utils/gitignore.py` | 101-221 | GitignoreParser class |
| `src/mcp_code_intelligence/core/indexer.py` | 179-191 | Gitignore parser initialization |
| `src/mcp_code_intelligence/core/indexer.py` | 1088-1146 | Path filtering logic |
| `src/mcp_code_intelligence/core/indexer.py` | 983-1013 | File scanning with filtering |
| `src/mcp_code_intelligence/config/settings.py` | 48-51 | `respect_gitignore` configuration |
...
**Research Artifacts:**
- Bug reproduction test: `/Users/masa/Projects/mcp-code-intelligence/test_gitignore_bug.py`
- Research document: `/Users/masa/Projects/mcp-code-intelligence/docs/research/gitignore-bug-analysis-2026-01-16.md`
