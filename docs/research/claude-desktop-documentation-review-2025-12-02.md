...
#### `mcp-code-intelligence setup --help`
...
This document describes how to use MCP Code Intelligence with Claude Code
through the Model Context Protocol (MCP) integration.

## Overview

The MCP integration allows you to use MCP Code Intelligence directly within
...
**Scenario 2: User Running `mcp-code-intelligence install --help`**
...
**Scenario 3: User Running `mcp-code-intelligence setup`**
...
- "Claude Code is the primary way to use mcp-code-intelligence"
...
if len(detected_platforms) > 1:
    ...
    console.print("[dim]   Run 'mcp-code-intelligence install <platform>' to configure manually[/dim]")
```
...
A: `setup` automatically detects and configures all available MCP platforms. To configure only Claude Code, use `mcp-code-intelligence install claude-code` instead.

**Q: How do I switch from Claude Desktop to Claude Code?**
A:
1. Uninstall Claude Desktop: `mcp-code-intelligence uninstall claude-desktop`
2. Install Claude Code: `mcp-code-intelligence install claude-code`
3. Restart your IDE
```
...
**Not sure which to choose?** Use `mcp-code-intelligence setup` which configures Claude Code by default.
```
...
The mcp-code-intelligence installer **correctly implements Claude Code as the primary target**, but the documentation could be clearer about:
...
**Files Reviewed**:
- /Users/masa/Projects/mcp-code-intelligence/README.md
- /Users/masa/Projects/mcp-code-intelligence/docs/getting-started/installation.md
- /Users/masa/Projects/mcp-code-intelligence/docs/guides/mcp-integration.md
- /Users/masa/Projects/mcp-code-intelligence/docs/reference/cli-commands.md
- /Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/install.py
- /Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/setup.py
