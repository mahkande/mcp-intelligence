...
**Source:** `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py` (lines 388-439)
...
## Recommended Approach for MCP Code Intelligence
...
- `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py` (1,827 lines)
- `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py` (578 lines)
