...
The `mcp-code-intelligence init --force` command **does NOT regenerate file extensions** to match the updated `DEFAULT_FILE_EXTENSIONS` list. It preserves the old extensions from the existing config file.
...
**File**: `src/mcp_code_intelligence/cli/commands/init.py`
...
1. **User runs**: `mcp-code-intelligence init --force`
...
**File**: `src/mcp_code_intelligence/config/defaults.py` (lines 14-108)
...
3. **Python imports old code**: When running `mcp-code-intelligence init --force`, Python uses **installed package**, not **source code**
...
/Users/masa/.local/share/uv/tools/mcp-code-intelligence/bin/python3 -c \
...
# Check source code
wc -l src/mcp_code_intelligence/config/defaults.py
...
pip install --upgrade --force-reinstall mcp-code-intelligence
...
mcp-code-intelligence init --force --reset-extensions
...
**Scenario**: User runs `pip install --upgrade mcp-code-intelligence` but forgets to run `init --force`.
...
- **CLI Entry Point**: `src/mcp_code_intelligence/cli/commands/init.py` (lines 36-196)
- **Project Manager**: `src/mcp_code_intelligence/core/project.py` (lines 79-159)
- **Config Model**: `src/mcp_code_intelligence/config/settings.py` (lines 11-50)
- **Default Extensions**: `src/mcp_code_intelligence/config/defaults.py` (lines 14-108)
- **Config Storage**: `.mcp-code-intelligence/config.json` (user's project)
