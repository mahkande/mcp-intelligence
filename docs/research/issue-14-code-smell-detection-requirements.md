...
**Related Design**: [Structural Code Analysis Design](mcp-code-intelligence-structural-analysis-design.md)
...
### Objective
Implement code smell detection for the `mcp-code-intelligence analyze` command to identify common maintainability issues in codebases.
...
### 2.1 Metrics Dataclasses (`src/mcp_code_intelligence/analysis/metrics.py`)
...
### 2.2 Metric Collectors (`src/mcp_code_intelligence/analysis/collectors/`)
...
### 2.3 Threshold Configuration (`src/mcp_code_intelligence/config/thresholds.py`)
...
**YAML Configuration** (`src/mcp_code_intelligence/config/default_thresholds.yaml`):
```yaml
smells:
...
### 2.4 CLI Analyze Command (`src/mcp_code_intelligence/cli/commands/analyze.py`)
...
**Expected Location**: `src/mcp_code_intelligence/analysis/collectors/smells.py`
...
```python
# src/mcp_code_intelligence/analysis/collectors/smells.py
...
threshold_config = ThresholdConfig.load(
    project_root / ".mcp-code-intelligence" / "thresholds.yaml"
)
...
```python
# src/mcp_code_intelligence/analysis/reporters/console.py
