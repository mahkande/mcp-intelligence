...
Analyzed the `mcp-code-intelligence init` CLI flags, default exclusion patterns, and supported languages to identify gaps in current defaults and provide accurate CLI usage documentation.
...
## 1. CLI Flags for `mcp-code-intelligence init`
...
mcp-code-intelligence init -e py,js,ts,txt,md

# Custom subset for Python-only projects
mcp-code-intelligence init -e .py,.pyi,.pyx

# TypeScript/JavaScript projects
mcp-code-intelligence init -e .ts,.tsx,.js,.jsx,.mjs
```
...
**Location:** `src/mcp_code_intelligence/config/defaults.py:112-134`
...
DEFAULT_IGNORE_PATTERNS = [
    ...
    ".mcp-code-intelligence",  # Own index directory
]
...
**Location:** `src/mcp_code_intelligence/config/defaults.py:137-168`
...
**Location:** `src/mcp_code_intelligence/parsers/registry.py:33-65`
...
**Location:** `src/mcp_code_intelligence/config/defaults.py:42-69`
...
```bash
# Python-only project
mcp-code-intelligence init -e .py,.pyi,.pyx,.txt,.md,.rst

# Full-stack JavaScript/TypeScript
mcp-code-intelligence init -e .ts,.tsx,.js,.jsx,.mjs,.json,.md

# Minimal configuration (documentation only)
mcp-code-intelligence init -e .md,.txt,.rst
```

**2. Post-Init Cleanup:**
```bash
# If you accidentally indexed with defaults, clean up and re-index
mcp-code-intelligence reset index --force
...
| File | Purpose |
|------|---------|
| `src/mcp_code_intelligence/cli/commands/init.py` | Init command implementation |
| `src/mcp_code_intelligence/config/defaults.py` | Default configurations |
| `src/mcp_code_intelligence/parsers/registry.py` | Parser registration |
| `src/mcp_code_intelligence/parsers/base.py` | Parser base classes |
...
```
mcp-code-intelligence init --help

Usage: mcp-code-intelligence init [OPTIONS]
