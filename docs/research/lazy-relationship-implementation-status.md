...
**File**: `src/mcp_code_intelligence/cli/commands/index.py:77-82`
...
**File**: `src/mcp_code_intelligence/core/indexer.py:464-486`
...
**File**: `src/mcp_code_intelligence/cli/commands/visualize/server.py:154-290`
...
**File**: `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py:392-398`
...
```bash
$ mcp-code-intelligence index --compute-relationships
...
# Verify CLI defaults
grep -A3 "skip_relationships" src/mcp_code_intelligence/cli/commands/index.py

# Verify indexer logic
grep -A10 "if not skip_relationships" src/mcp_code_intelligence/core/indexer.py
```
...
- `src/mcp_code_intelligence/cli/commands/index.py` - CLI defaults
- `src/mcp_code_intelligence/core/indexer.py` - Indexing logic
- `src/mcp_code_intelligence/core/relationships.py` - Relationship computation
- `src/mcp_code_intelligence/cli/commands/visualize/server.py` - Lazy loading API
- `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py` - Graph construction
