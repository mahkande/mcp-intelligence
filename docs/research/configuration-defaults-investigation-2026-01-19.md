...
1. **Default values** defined in `/src/mcp_code_intelligence/config/defaults.py`
2. **Schema/validation** in `/src/mcp_code_intelligence/config/settings.py`
3. **Initialization logic** in `/src/mcp_code_intelligence/cli/commands/init.py`
4. **Usage in indexer** at `/src/mcp_code_intelligence/core/indexer.py`
...
**Location:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/config/settings.py`
...
**Usage in Indexer:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/indexer.py`
...
**Location:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/config/defaults.py`
...
DEFAULT_IGNORE_PATTERNS = [
    ...
    ".mcp-code-intelligence",  # Our own index directory
]
```
...
**Location:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/init.py`
...
**Location:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/project.py`
...
**Saved to:** `{project_root}/.mcp-code-intelligence/config.json`

---

### 7. Usage in SemanticIndexer

**Location:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/indexer.py`
...
2. INITIALIZATION (init command)
   ...
   └─ core/project.py
      ...
      └─ Saves to .mcp-code-intelligence/config.json

3. RUNTIME USAGE
   └─ core/indexer.py
      ├─ Loads config from .mcp-code-intelligence/config.json
...
3. **Verify config file:**
   ```bash
   cat .mcp-code-intelligence/config.json | jq '.respect_gitignore'
...
- Users must run `mcp-code-intelligence init --force` to update existing projects
...
**Critical Note:** Changing defaults only affects **NEW** project initializations. Existing projects use saved configuration in `.mcp-code-intelligence/config.json` unless re-initialized with `--force`.
