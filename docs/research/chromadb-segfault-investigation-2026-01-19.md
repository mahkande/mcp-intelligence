...
**Date**: 2026-01-19
**Issue**: Segmentation fault in `mcp-code-intelligence status` command on large databases
...
│   1. mcp-code-intelligence index clean                              │
...
1. **Enhance Error Messaging**
   ...
   - Add suggestion to check `~/.cache/mcp-code-intelligence/chroma.sqlite3` size
...
**Application Code**:
- `src/mcp_code_intelligence/cli/commands/status.py:201` - Calls `database.get_stats()`
- `src/mcp_code_intelligence/core/database.py:582` - Calls `collection.count()`

**Protection Mechanisms**:
- `src/mcp_code_intelligence/cli/commands/status.py:130` - 30s async timeout
- `src/mcp_code_intelligence/core/database.py:648` - Exception handler (returns empty stats)
- `src/mcp_code_intelligence/cli/main.py:55` - SIGSEGV signal handler
...
- Codebase analysis: `src/mcp_code_intelligence/core/database.py`, `src/mcp_code_intelligence/cli/commands/status.py`, `docs/development/crash-diagnostics.md`
