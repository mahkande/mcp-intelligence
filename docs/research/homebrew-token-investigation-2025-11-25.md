...
This commit added:
- `/Users/masa/Projects/mcp-code-intelligence/scripts/update_homebrew_formula.py` - Python automation script
- `/Users/masa/Projects/mcp-code-intelligence/.github/workflows/update-homebrew.yml` - GitHub Actions workflow
...
**Purpose:** Authenticate to GitHub when pushing changes to the tap repository (`bobmatnyc/homebrew-mcp-code-intelligence`)

**Used By:**
1. **Script:** `/Users/masa/Projects/mcp-code-intelligence/scripts/update_homebrew_formula.py`
...
2. **GitHub Actions:** `/Users/masa/Projects/mcp-code-intelligence/.github/workflows/update-homebrew.yml`
...
2. Extracts repo path from URL: `bobmatnyc/homebrew-mcp-code-intelligence`
...
**Target Repository:** `https://github.com/bobmatnyc/homebrew-mcp-code-intelligence.git`

**What It Updates:**
- Formula file: `Formula/mcp-code-intelligence.rb` (or `mcp-code-intelligence.rb` in root)
- Updates version number and SHA256 hash
- Commits with message: `chore: update formula to {version}`
- Pushes to `origin/main`

**Local Clone Location:** `~/.homebrew_tap_update/homebrew-mcp-code-intelligence`
...
1. **Go to Repository Settings:**
   - Visit: https://github.com/bobmatnyc/mcp-code-intelligence/settings/secrets/actions
...
git clone https://github.com/bobmatnyc/homebrew-mcp-code-intelligence.git ~/homebrew-tap
...
export HOMEBREW_TAP_REPO="git@github.com:bobmatnyc/homebrew-mcp-code-intelligence.git"
```
...
# Check: https://github.com/bobmatnyc/mcp-code-intelligence/actions
...
1. `/Users/masa/Projects/mcp-code-intelligence/scripts/README_HOMEBREW_FORMULA.md` - Full documentation (536 lines)
2. `/Users/masa/Projects/mcp-code-intelligence/scripts/HOMEBREW_QUICKSTART.md` - Quick reference (119 lines)
3. `/Users/masa/Projects/mcp-code-intelligence/scripts/HOMEBREW_WORKFLOW.md` - Workflow guide (463 lines)
4. `/Users/masa/Projects/mcp-code-intelligence/docs/HOMEBREW_INTEGRATION.md` - Integration guide (467 lines)
5. `/Users/masa/Projects/mcp-code-intelligence/docs/HOMEBREW_QUICKSTART.md` - Quick start (157 lines)
...
3. **Set GitHub:** https://github.com/bobmatnyc/mcp-code-intelligence/settings/secrets/actions
...
1. `/Users/masa/Projects/mcp-code-intelligence/scripts/update_homebrew_formula.py` - 719 lines
2. `/Users/masa/Projects/mcp-code-intelligence/.github/workflows/update-homebrew.yml` - 122 lines
3. `/Users/masa/Projects/mcp-code-intelligence/Makefile` - Lines 485-514 (Homebrew targets)
4. `/Users/masa/Projects/mcp-code-intelligence/scripts/README_HOMEBREW_FORMULA.md` - 536 lines
5. `/Users/masa/Projects/mcp-code-intelligence/scripts/HOMEBREW_QUICKSTART.md` - 119 lines
