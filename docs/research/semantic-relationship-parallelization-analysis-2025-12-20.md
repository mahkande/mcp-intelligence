...
**Triggered From**:
- `src/mcp_code_intelligence/core/indexer.py` line 475 → `relationship_store.compute_and_store()`
- `src/mcp_code_intelligence/cli/commands/index.py` line 408 → relationship computation during indexing
...
**File**: `src/mcp_code_intelligence/core/database.py` line 438
...
1. **`src/mcp_code_intelligence/core/relationships.py`**
...
2. **`src/mcp_code_intelligence/core/indexer.py`**
...
4. **`src/mcp_code_intelligence/cli/commands/index.py`**
