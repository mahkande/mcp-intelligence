...
**What It Does**:
1. ✅ Creates `.mcp-code-intelligence/` directory for vector database
...
- ✅ **Project root**: Detects via `.git`, `.mcp-code-intelligence`, `pyproject.toml`, `package.json`, etc.
...
│  ├─ Create .mcp-code-intelligence/ directory
...
**Primary Function**: Install mcp-code-intelligence + MCP integrations for multiple platforms
...
1. **Project Root Detection** (`ProjectManager._detect_project_root()`):
   - Walks up directory tree looking for:
     - `.git` (Git repository)
     - `.mcp-code-intelligence` (already initialized)
...
🚀 Initializing mcp-code-intelligence...
  ✅ Created .mcp-code-intelligence/ directory
...
Next steps:
  ...
  • Check status: mcp-code-intelligence status

Configuration summary saved to .mcp-code-intelligence/setup.log
```
...
```
src/mcp_code_intelligence/cli/commands/
...
async def main(
    ...
    """🚀 Smart zero-config setup for mcp-code-intelligence.
    ...
    try:
        ...
        if not already_init or force:
            console.print("\n[bold blue]🚀 Initializing mcp-code-intelligence...[/bold blue]")
        ...
        next_steps = [
            "Open Claude Code in this directory",
            "Try: 'Search for authentication functions'",
            "[cyan]mcp-code-intelligence status[/cyan] - Check project status",
        ]
...
**Files Analyzed**:
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/init.py` (646 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/install.py` (679 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/mcp.py` (1183 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/project.py` (351 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/config/defaults.py` (201 lines)
