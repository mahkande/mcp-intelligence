...
#### 1. `/src/mcp_code_intelligence/core/search.py`
...
#### 2. `/src/mcp_code_intelligence/core/models.py`
...
#### 3. `/src/mcp_code_intelligence/core/database.py`
...
#### 4. `/src/mcp_code_intelligence/parsers/registry.py`
...
Add to `/src/mcp_code_intelligence/cli/commands/search.py`:
...
# Include boilerplate
mcp-code-intelligence search "authentication" --no-filter-boilerplate

# Penalize instead of filter
mcp-code-intelligence search "authentication" --boilerplate-penalty 0.15

# Explicitly search for boilerplate (auto-detected)
mcp-code-intelligence search "__init__ method"  # Won't filter __init__
```
...
Add to project configuration (`.mcp-code-intelligence/config.json`):
...
- Search implementation: `/src/mcp_code_intelligence/core/search.py`
- Data models: `/src/mcp_code_intelligence/core/models.py`
- Database layer: `/src/mcp_code_intelligence/core/database.py`
- Parser registry: `/src/mcp_code_intelligence/parsers/registry.py`
- CLI search: `/src/mcp_code_intelligence/cli/commands/search.py`
