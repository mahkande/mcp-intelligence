...
The `SemanticIndexer` class in `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/indexer.py` is being indexed as BOTH:
...
**File Analyzed:** `src/mcp_code_intelligence/core/indexer.py`
- Total lines: 1248
...
The Python parser (`src/mcp_code_intelligence/parsers/python.py`) uses a dual-chunking strategy:
...
Analysis of `.mcp-code-intelligence/chunk-graph.json` reveals:
...
Checked `src/mcp_code_intelligence/config/constants.py`:
...
**Files Analyzed:**
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/parsers/python.py` (lines 83-220)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/parsers/base.py` (lines 165-222)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/config/constants.py` (lines 14-16)
- `/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/chunk-graph.json` (runtime data)
