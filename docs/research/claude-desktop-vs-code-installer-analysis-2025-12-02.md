...
**Finding**: The mcp-code-intelligence installer **correctly targets only Claude Code** (project-based), not Claude Desktop.

**CLAUDE.md Confusion**: The CLAUDE.md file mentioning "Claude Desktop" is **NOT generated by mcp-code-intelligence**. It's created by an external tool called **KuzuMemory Claude Hooks Installer**.
...
**Recommendation**: No changes needed to installer. The confusion comes from KuzuMemory's CLAUDE.md, which is unrelated to mcp-code-intelligence's installer.
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/CLAUDE.md`

**Key Finding**: Generated by KuzuMemory, not mcp-code-intelligence
...
- **Conclusion**: mcp-code-intelligence installer has NO involvement in CLAUDE.md generation
...
- This is NOT indicative of mcp-code-intelligence's installer behavior

---

### 2. mcp-code-intelligence Installer Architecture

**Primary Installation Flow**:

#### Main Install Command
**File**: `src/mcp_code_intelligence/cli/commands/install.py`
**Command**: `mcp-code-intelligence install`
...
**Command**: `mcp-code-intelligence install claude-code`
...
**Command**: `mcp-code-intelligence install claude-desktop`
...
- Command: `mcp-code-intelligence install claude-desktop`
- NOT run by default
- NOT run by `mcp-code-intelligence install --with-mcp` unless Claude Desktop directory exists
...
**Command**: `mcp-code-intelligence setup`
...
[bold cyan]Usage Patterns:[/bold cyan]
  ...
  [green]2. MCP Platform Integration[/green]
     ...
     [code]$ mcp-code-intelligence install claude-code[/code]
     [code]$ mcp-code-intelligence install cursor[/code]
     [code]$ mcp-code-intelligence install windsurf[/code]
...
def register_with_claude_cli(
    ...
    Args:
        ...
        server_name: Name for the MCP server entry (default: "mcp-code-intelligence")
...
2. If yes: Run `claude mcp add mcp-code-intelligence ...`
...
3. Add `mcp-code-intelligence` server to `mcpServers` section
...
1. **Install Command**: `src/mcp_code_intelligence/cli/commands/install.py` (807 lines)
   - Main install logic
   - Platform-specific subcommands
   - Claude CLI integration

2. **Setup Command**: `src/mcp_code_intelligence/cli/commands/setup.py` (591 lines)
   - Smart zero-config setup
   - Auto-detection logic
   - Platform configuration

3. **CLAUDE.md**: `/Users/masa/Projects/mcp-code-intelligence/CLAUDE.md` (50 lines)
   - **Generated by KuzuMemory**, not mcp-code-intelligence
...
- No code in mcp-code-intelligence that writes CLAUDE.md
...
- Not part of mcp-code-intelligence's responsibility
- Users who installed KuzuMemory chose to use it
- No action needed from mcp-code-intelligence

**Option 2: Document in README**
- Add note: "CLAUDE.md may be generated by tools like KuzuMemory"
- Clarify: "mcp-code-intelligence installer targets Claude Code by default"
...
**Verdict**: No action required. CLAUDE.md confusion is external to mcp-code-intelligence.
...
The mcp-code-intelligence installer:
...
- The CLAUDE.md file mentioning "Claude Desktop" is **NOT generated by mcp-code-intelligence**
- It's created by **KuzuMemory Claude Hooks Installer** (external tool)
- This file is unrelated to mcp-code-intelligence's installation behavior
...
|---------|--------|-------|----------|
| `mcp-code-intelligence install` | None (project init only) | Project | YES |
| `mcp-code-intelligence install claude-code` | Claude Code | Project | Recommended |
| `mcp-code-intelligence install claude-desktop` | Claude Desktop | Global | Opt-in |
| `mcp-code-intelligence install --with-mcp` | All detected | Mixed | Optional |
| `mcp-code-intelligence setup` | All detected (fallback: claude-code) | Mixed | Smart default |

**Recommendation for Users**:
- Use `mcp-code-intelligence setup` for zero-config installation
- Use `mcp-code-intelligence install claude-code` for explicit Claude Code integration
- Only use `mcp-code-intelligence install claude-desktop` if you specifically need global Claude Desktop integration
