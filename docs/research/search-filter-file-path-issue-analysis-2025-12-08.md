...
```bash
mcp-code-intelligence search --language typescript "query"
```

**3. Use exact file path if you know the file:**
```bash
# This would work if you know the exact relative path from project root
mcp-code-intelligence search --files "src/components/Query.ts" "query"
```

**4. Lower similarity threshold explicitly:**
```bash
mcp-code-intelligence search --threshold 0.1 "query"
```
...
mcp-code-intelligence search "GraphQL query implementation"
```

---

## Recommendations for mcp-code-intelligence Maintainers
...
1. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/search.py`
   - Lines 61-67: `--files` parameter definition
   - Lines 337-339: Filter building (problem location)
   - Lines 250-429: `run_search()` function

2. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/search.py`
   - Lines 109-212: `search()` method
   - Lines 321-392: Adaptive threshold logic

3. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/database.py`
...
4. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/status.py`
