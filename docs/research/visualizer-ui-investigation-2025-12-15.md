# MCP Code Intelligence Visualizer - UI Investigation
...
Investigated the mcp-code-intelligence visualizer UI to understand report controls, filtering behavior, and dependency analysis functionality. Found critical bug where filtering nodes by Code/Docs type leaves "nodeless lines" (tree structure links) visible. Report generators are functional and well-integrated.
