...
The mcp-code-intelligence visualization is **NOT using a force-directed graph** as the user suspected. The codebase has two rendering systems:
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize/layout_engine.py`
...
3. **`src/mcp_code_intelligence/cli/commands/visualize/layout_engine.py`**
