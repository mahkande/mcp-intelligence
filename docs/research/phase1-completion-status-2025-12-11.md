...
**Project**: mcp-code-intelligence - Structural Code Analysis
...
- File: `src/mcp_code_intelligence/analysis/metrics.py`
...
- File: `src/mcp_code_intelligence/analysis/collectors/complexity.py`
...
- File: `src/mcp_code_intelligence/core/indexer.py`
...
- File: `src/mcp_code_intelligence/core/database.py`
...
- File: `src/mcp_code_intelligence/cli/commands/analyze.py`
- Commit: 6c8c99c "feat(cli): add analyze command with console reporter (#10, #11)"
- Command registered in: `src/mcp_code_intelligence/cli/main.py` (lines 119, 183-185)
- Features:
  ...
  - `--json` output
  - `--top N` hotspots
- Console reporter: `src/mcp_code_intelligence/analysis/reporters/console.py`
...
- Users running `mcp-code-intelligence analyze` get: "Error: No such command 'analyze'"
...
6. **Verify user access** (validation):
   ```bash
   pipx upgrade mcp-code-intelligence
   mcp-code-intelligence analyze --help  # Should work!
   ```
...
- `src/mcp_code_intelligence/analysis/__init__.py`
- `src/mcp_code_intelligence/analysis/metrics.py` (11,904 bytes)
- `src/mcp_code_intelligence/analysis/collectors/__init__.py`
- `src/mcp_code_intelligence/analysis/collectors/base.py`
- `src/mcp_code_intelligence/analysis/collectors/complexity.py` (743 lines)
- `src/mcp_code_intelligence/analysis/reporters/__init__.py`
- `src/mcp_code_intelligence/analysis/reporters/console.py` (222 lines)

**CLI Commands** (1 file):
- `src/mcp_code_intelligence/cli/commands/analyze.py` (408 lines)

**Configuration** (2 files):
- `src/mcp_code_intelligence/config/thresholds.py` (185 lines)
- `src/mcp_code_intelligence/config/default_thresholds.yaml` (52 lines)
...
**Core** (3 files):
- `src/mcp_code_intelligence/core/indexer.py` (+225 lines)
- `src/mcp_code_intelligence/core/database.py` (+118 lines, -43 lines)
- `src/mcp_code_intelligence/config/__init__.py` (+4 lines)

**CLI** (1 file):
- `src/mcp_code_intelligence/cli/main.py` (+12 lines analyze registration)
...
- **Milestone v0.17.0**: https://github.com/bobmatnyc/mcp-code-intelligence/milestones
- **Phase 1 Epic**: https://github.com/bobmatnyc/mcp-code-intelligence/issues/1
- **Phase 2 Epic**: https://github.com/bobmatnyc/mcp-code-intelligence/issues/12
