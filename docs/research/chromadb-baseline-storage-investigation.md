...
- Baselines stored as **JSON files** in `~/.mcp-code-intelligence/baselines/`
...
- **Database Location**: `.mcp-code-intelligence/chroma.sqlite3`
- **Database Size**: 73 MB (for mcp-code-intelligence codebase)
...
```sql
embedding_id: /Users/masa/Projects/mcp-code-intelligence/CHANGELOG.md:3:6

metadata = {
    "file_path": "/Users/masa/Projects/mcp-code-intelligence/CHANGELOG.md",
    "start_line": 3,
    "end_line": 6,
    "language": "text",
    "chunk_type": "text",
...
**Primary Directory**: `~/.mcp-code-intelligence/baselines/`
...
**Architecture**:
- **Primary Storage**: JSON files (`~/.mcp-code-intelligence/baselines/`)
...
→ saves to ~/.mcp-code-intelligence/baselines/main.json
...
**Database Location**: `/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/chroma.sqlite3`
...
**Baseline Management**:
- `src/mcp_code_intelligence/analysis/baseline/manager.py` (622 lines)
  - `BaselineManager`: Save/load/list/delete baselines
  - `GitInfo`: Git metadata tracking
  - `BaselineMetadata`: Baseline file metadata
  - Storage: `~/.mcp-code-intelligence/baselines/`

**ChromaDB Integration**:
- `src/mcp_code_intelligence/core/database.py` (1490 lines)
  ...
  - Storage: `.mcp-code-intelligence/chroma.sqlite3`

**Metrics Dataclasses**:
- `src/mcp_code_intelligence/analysis/metrics.py`
...
→ Stores in ~/.mcp-code-intelligence/baselines/main.json
```
...
4. **Implement SQLite metrics store** (Issue #24):
   - Separate database: `.mcp-code-intelligence/metrics.db`
...
7. **Baseline indexing** (if query performance needed):
   ...
   - Separate index file: `.mcp-code-intelligence/baseline_index.db`
...
The current architecture of storing baselines as JSON files in `~/.mcp-code-intelligence/baselines/` is **well-suited for the intended use case**. While ChromaDB could technically store baseline data, it would introduce complexity without significant benefits at this stage.
...
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/database.py` (1490 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/models.py` (298 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/analysis/baseline/manager.py` (622 lines)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/analysis/metrics.py` (269+ lines)

### Database Files

- **ChromaDB**: `/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/chroma.sqlite3` (73 MB)
- **Baselines**: `/Users/masa/.mcp-code-intelligence/baselines/` (empty, no baselines created yet)

### Documentation

- `/Users/masa/Projects/mcp-code-intelligence/docs/projects/structural-code-analysis.md`
- `/Users/masa/Projects/mcp-code-intelligence/docs/research/mcp-code-intelligence-structural-analysis-design.md`
