...
**Location:** `/src/mcp_code_intelligence/cli/commands/visualize/templates/`
...
**File:** `src/mcp_code_intelligence/cli/commands/visualize/server.py`
...
**File:** `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
...
**File:** `src/mcp_code_intelligence/cli/commands/visualize/templates/base.py`
...
**File:** `src/mcp_code_intelligence/analysis/visualizer/exporter.py`
...
1. **Graph Building:**
   - `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py`
...
3. **Frontend JavaScript:**
   - `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
     - Lines 3532-3713: `showDependencies()` function
     - Lines 3715-3745: `buildFileDependencyGraph()` function
     - Line 3720: `if (link.type === 'caller')` - filtering condition

4. **HTML Template:**
   - `src/mcp_code_intelligence/cli/commands/visualize/templates/base.py`
     - Line 151: Dependencies button definition

### Supporting Files

5. **Dependency Graph Export:**
   - `src/mcp_code_intelligence/analysis/visualizer/exporter.py`
