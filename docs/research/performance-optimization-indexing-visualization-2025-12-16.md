...
This research identifies **5 critical performance bottlenecks** in the mcp-code-intelligence indexing and visualization pipeline, with concrete optimization recommendations prioritized by effort-to-impact ratio.
...
**Location:** `src/mcp_code_intelligence/core/database.py:425-430`
...
**Location:** `src/mcp_code_intelligence/core/indexer.py:454-472`
...
**Location:** `src/mcp_code_intelligence/core/relationships.py:204-294`
...
**Location:** `src/mcp_code_intelligence/core/indexer.py:860-890`
...
**Location:** `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py:556-569`
...
**Files to Modify:**
1. `src/mcp_code_intelligence/core/indexer.py` (main logic)
2. `src/mcp_code_intelligence/core/database.py` (ensure batching respected)
...
```python
# src/mcp_code_intelligence/core/embeddings.py
...
```python
# src/mcp_code_intelligence/cli/commands/visualize/server.py (API endpoint)
...
```python
# src/mcp_code_intelligence/cli/commands/visualize/server.py
...
py-spy record -o profile.svg -- mcp-code-intelligence index

# Memory profiling with memray
memray run mcp-code-intelligence index
...
**Core Indexing:**
- `src/mcp_code_intelligence/core/indexer.py` (1278 lines)
  - Main indexing pipeline
  - Batch processing logic
  - File discovery and filtering

**Database Operations:**
- `src/mcp_code_intelligence/core/database.py` (800+ lines)
  - ChromaDB integration
  - Chunk insertion and embedding

**Embeddings:**
- `src/mcp_code_intelligence/core/embeddings.py` (300 lines)
  - SentenceTransformer wrapper
  - Embedding cache (LRU + disk)
  - TOKENIZERS_PARALLELISM configuration

**Visualization:**
- `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py` (647 lines)
  - Graph data construction
  - Directory index loading
  - Relationship integration

**Relationships:**
- `src/mcp_code_intelligence/core/relationships.py` (400+ lines)
...
The mcp-code-intelligence indexing pipeline has clear, actionable optimization opportunities that can deliver **4-8x total speedup** with 1-2 weeks of focused effort.
