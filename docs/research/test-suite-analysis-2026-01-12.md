# Test Suite Quality Analysis - mcp-code-intelligence
**Date:** 2026-01-12
...
The mcp-code-intelligence project has **1213 passing tests** across 112 test files. While the test suite is comprehensive, there are significant quality issues including:
...
```python
with (
    patch("mcp_code_intelligence.core.llm_client.LLMClient"),
    patch("mcp_code_intelligence.core.project.ProjectManager"),
    patch("mcp_code_intelligence.core.config_utils.get_openai_api_key"),
    patch("mcp_code_intelligence.core.config_utils.get_openrouter_api_key"),
    patch("mcp_code_intelligence.parsers.registry.ParserRegistry"),
    patch("mcp_code_intelligence.analysis.ProjectMetrics"),
    patch("mcp_code_intelligence.analysis.interpretation.EnhancedJSONExporter"),
):
```
