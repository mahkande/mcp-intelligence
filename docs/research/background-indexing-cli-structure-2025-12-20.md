...
**Objective:** Investigate CLI structure for adding background indexing mode to mcp-code-intelligence

## Executive Summary

The mcp-code-intelligence CLI uses Typer with a clear command hierarchy and asyncio for indexing operations. Background indexing can be implemented using Python's subprocess.Popen with detachment, leveraging existing progress tracking infrastructure through JSON status files in `.mcp-code-intelligence/`.

**Key Findings:**
- CLI entry point: `src/mcp_code_intelligence/cli/main.py`
- Index command: `src/mcp_code_intelligence/cli/commands/index.py`
- Indexer implementation: `src/mcp_code_intelligence/core/indexer.py`
- Existing scheduler patterns in `scheduler.py` provide subprocess examples
- Progress files already stored in `.mcp-code-intelligence/` directory
...
**File:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/main.py`
...
**File:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/index.py`
...
**File:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/indexer.py`
...
**File:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/scheduler.py`
...
**File:** `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/auto_index.py`
...
**Location:** `.mcp-code-intelligence/`
...
**File:** `.mcp-code-intelligence/index_metadata.json`
...
**Location:** `.mcp-code-intelligence/indexing_progress.json`
...
def spawn_background_indexer(
    ...
    cmd = [
        python_exe,
        "-m", "mcp_code_intelligence.cli.commands.index_background",
...
**Command:** `mcp-code-intelligence index status`

**Functionality:**
- Read `.mcp-code-intelligence/indexing_progress.json`
...
**Command:** `mcp-code-intelligence index cancel`
...
**Decision:** Use JSON progress file in `.mcp-code-intelligence/`
...
**Location:** `.mcp-code-intelligence/indexing_background.log`
...
- Provide recovery command: `mcp-code-intelligence index health --repair`
...
```
src/mcp_code_intelligence/cli/commands/index.py
...
```bash
# Start background indexing
$ mcp-code-intelligence index --background
Starting background indexing (PID: 12345)
Progress file: .mcp-code-intelligence/indexing_progress.json
Log file: .mcp-code-intelligence/indexing_background.log

Use 'mcp-code-intelligence index status' to check progress
```

### Check Status
```bash
$ mcp-code-intelligence index status
...
### Cancel Indexing
```bash
$ mcp-code-intelligence index cancel
...
The mcp-code-intelligence CLI is well-structured for adding background indexing:
...
- Store progress in `.mcp-code-intelligence/indexing_progress.json`
