...
**Date:** 2025-12-10
**Issue:** `mcp-code-intelligence index` command crashes with Rust panic
...
```python
# src/mcp_code_intelligence/cli/commands/search.py:120-140
try:
...
```bash
# Database directory
/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/
...
```python
import pickle
with open('.mcp-code-intelligence/4c516ee3.../index_metadata.pickle', 'rb') as f:
...
sqlite3 .mcp-code-intelligence/chroma.sqlite3 "INSERT INTO bad_table VALUES (99999);"
