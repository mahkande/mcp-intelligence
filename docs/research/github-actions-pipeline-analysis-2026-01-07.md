...
- **Location**: `/Users/masa/Projects/mcp-code-intelligence/.github/workflows/ci.yml`
...
- **Location**: `/Users/masa/Projects/mcp-code-intelligence/.github/workflows/update-homebrew.yml`
...
**Root Cause**:
- Job expects `docs/CHANGELOG.md` but actual file is at `/Users/masa/Projects/mcp-code-intelligence/CHANGELOG.md` (root level)
- Job expects `docs/VERSIONING_WORKFLOW.md` which **does not exist anywhere** in the repository

**Evidence**:
```bash
$ ls -la /Users/masa/Projects/mcp-code-intelligence/docs/CHANGELOG.md
ls: /Users/masa/Projects/mcp-code-intelligence/docs/CHANGELOG.md: No such file or directory

$ find /Users/masa/Projects/mcp-code-intelligence -name "VERSIONING*.md"
(no results - file doesn't exist)

$ ls -la /Users/masa/Projects/mcp-code-intelligence/CHANGELOG.md
-rw-r--r--@ 1 masa staff <size> <date> /Users/masa/Projects/mcp-code-intelligence/CHANGELOG.md
```
...
test:
  ...
  steps:
    - name: Run tests
      run: uv run pytest tests/ -v --cov=src/mcp_code_intelligence
```
