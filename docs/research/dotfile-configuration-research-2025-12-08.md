...
**File**: `src/mcp_code_intelligence/cli/commands/config.py`
...
**File**: `src/mcp_code_intelligence/cli/commands/index.py`
...
mcp-code-intelligence index --include-dotfiles

# Or inverse flag for clarity
mcp-code-intelligence index --no-skip-dotfiles
```
...
```python
# In src/mcp_code_intelligence/cli/commands/index.py
...
✅ **Persistence**: Config saved to `.mcp-code-intelligence/config.json`
...
- `src/mcp_code_intelligence/config/settings.py` - Configuration model
- `src/mcp_code_intelligence/cli/commands/config.py` - Config CLI commands
- `src/mcp_code_intelligence/cli/commands/index.py` - Index CLI commands
- `src/mcp_code_intelligence/cli/commands/init.py` - Init CLI commands
- `src/mcp_code_intelligence/core/indexer.py` - Core indexing logic
...
The `skip_dotfiles` configuration in mcp-code-intelligence is **production-ready and well-documented**:
...
# Edit .mcp-code-intelligence/config.json manually
{
  "skip_dotfiles": false,
...
```python
# Proposed addition to src/mcp_code_intelligence/cli/commands/index.py
...
mcp-code-intelligence config get skip_dotfiles  # Should still be true
```
