...
This research provides a comprehensive analysis of implementing the `analyze --quick` CLI command for mcp-code-intelligence. The command will perform structural code analysis using existing metric collectors and output results to the console.
...
- Single-file implementation: `/src/mcp_code_intelligence/cli/commands/analyze.py`
...
**Location**: `/src/mcp_code_intelligence/cli/main.py`
...
```python
"""Status command for MCP Code Intelligence CLI."""
import typer
...
**Location**: `/src/mcp_code_intelligence/cli/output.py`
...
**Location**: `/src/mcp_code_intelligence/analysis/collectors/`
...
**Location**: `/src/mcp_code_intelligence/analysis/metrics.py`
...
**Location**: `/src/mcp_code_intelligence/core/indexer.py`
...
mcp-code-intelligence analyze --path src/

# Filter by language
mcp-code-intelligence analyze --language python

# JSON output
mcp-code-intelligence analyze --json

# Limit to top N hotspots
mcp-code-intelligence analyze --top 10

# Verbose output with per-file details
mcp-code-intelligence analyze --verbose

# Combined options
mcp-code-intelligence analyze --quick --language typescript --top 5
```
...
Project Summary
  Root: /Users/masa/Projects/mcp-code-intelligence
...
💡 Run 'mcp-code-intelligence analyze' for full analysis
```
...
```
src/mcp_code_intelligence/cli/commands/analyze.py
```
...
```
src/mcp_code_intelligence/cli/commands/analyze/
...
- [ ] Create `/src/mcp_code_intelligence/cli/commands/analyze.py`
...
### CLI Files
- `/src/mcp_code_intelligence/cli/main.py` - Main CLI app
- `/src/mcp_code_intelligence/cli/commands/status.py` - Status command (pattern)
- `/src/mcp_code_intelligence/cli/commands/search.py` - Search command (pattern)
- `/src/mcp_code_intelligence/cli/commands/visualize/cli.py` - Subdirectory pattern
- `/src/mcp_code_intelligence/cli/output.py` - Output utilities

### Analysis Files
- `/src/mcp_code_intelligence/analysis/collectors/base.py` - Collector interface
- `/src/mcp_code_intelligence/analysis/collectors/complexity.py` - Complexity collectors
- `/src/mcp_code_intelligence/analysis/metrics.py` - Metric dataclasses
- `/src/mcp_code_intelligence/core/indexer.py` - Indexer with collector integration
