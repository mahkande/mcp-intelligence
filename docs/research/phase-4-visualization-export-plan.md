...
**Epic**: [#27 - Visualization Export](https://github.com/bobmatnyc/mcp-code-intelligence/issues/27)
**Milestone**: v0.20.0 (Due: January 13, 2025)

## Executive Summary

Phase 4 adds comprehensive visualization and export capabilities to mcp-code-intelligence. This phase builds on the completed foundation (Phases 1-3) and delivers JSON/HTML exports, Halstead complexity metrics, technical debt estimation, and enhanced CLI reporting.
...
**Metrics System** (`src/mcp_code_intelligence/analysis/metrics.py`):
...
**Collectors** (`src/mcp_code_intelligence/analysis/collectors/`):
...
**Reporters** (`src/mcp_code_intelligence/analysis/reporters/`):
...
**Storage** (`src/mcp_code_intelligence/analysis/storage/`):
...
**Acceptance Criteria**:
- ✅ Command `mcp-code-intelligence status --metrics` displays summary
...
```toml
[tool.mcp-code-intelligence.debt]
...
2. Run `mcp-code-intelligence analyze --export-viz report.json`
3. Verify JSON validates against schema
4. Run `mcp-code-intelligence analyze --export-viz report.html`
...
- [Issue #27: [EPIC] Visualization Export](https://github.com/bobmatnyc/mcp-code-intelligence/issues/27)
- [Issue #28: Design JSON Export Schema](https://github.com/bobmatnyc/mcp-code-intelligence/issues/28)
- [Issue #29: Implement JSON Exporter](https://github.com/bobmatnyc/mcp-code-intelligence/issues/29)
- [Issue #30: Create HTML Standalone Report](https://github.com/bobmatnyc/mcp-code-intelligence/issues/30)
- [Issue #31: Implement Halstead Metrics](https://github.com/bobmatnyc/mcp-code-intelligence/issues/31)
- [Issue #32: Add Technical Debt Estimation](https://github.com/bobmatnyc/mcp-code-intelligence/issues/32)
- [Issue #33: Extend status Command with Metrics](https://github.com/bobmatnyc/mcp-code-intelligence/issues/33)

### Project Documentation

- [Structural Code Analysis Project](https://github.com/bobmatnyc/mcp-code-intelligence/blob/main/docs/projects/structural-code-analysis.md)
- [Design Document](https://github.com/bobmatnyc/mcp-code-intelligence/blob/main/docs/research/mcp-code-intelligence-structural-analysis-design.md)
...
- [ ] Set up module: `src/mcp_code_intelligence/analysis/visualizer/schemas.py`
