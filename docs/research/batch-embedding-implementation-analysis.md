...
**Working Directory:** /Users/masa/Projects/mcp-code-intelligence
...
**Files to Modify:**
1. `src/mcp_code_intelligence/core/indexer.py`
...
- [ ] Test with mcp-code-intelligence codebase (dogfooding)
...
- **Files Analyzed:**
  ...
  - `src/mcp_code_intelligence/core/database.py` (1527 lines)
  - `src/mcp_code_intelligence/core/embeddings.py` (319 lines)
