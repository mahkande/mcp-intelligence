...
mcp-code-intelligence has evolved a sophisticated setup system with three primary entry points:
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/setup.py`

**Zero-Config Smart Setup** - The recommended installation method:

```bash
mcp-code-intelligence setup [--force] [--verbose]
```
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/install.py`

**Manual Setup** - For users needing fine-grained control:

```bash
mcp-code-intelligence install [OPTIONS]
# OR
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/init.py` (not shown in full)

**Basic Initialization** - Minimal setup:

```bash
mcp-code-intelligence init [--extensions .py,.js] [--force]
```

**Workflow**:
1. Create `.mcp-code-intelligence/` directory
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/README.md`
...
mcp-code-intelligence install claude-desktop
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/docs/getting-started/installation.md`
...
```bash
# Add MCP Integration
mcp-code-intelligence install claude-code    # Project-scoped
mcp-code-intelligence install cursor         # Global
mcp-code-intelligence install claude-desktop # Global
mcp-code-intelligence install windsurf       # Global
mcp-code-intelligence install vscode         # Global
...
**File**: `/Users/masa/Projects/mcp-code-intelligence/docs/guides/mcp-integration.md`
...
```bash
claude mcp add mcp-code-intelligence uv run mcp-code-intelligence mcp
```
...
|-----------|-----------|-------|
| Setup command | `src/mcp_code_intelligence/cli/commands/setup.py` | 1-448 |
| Install command | `src/mcp_code_intelligence/cli/commands/install.py` | 1-679 |
| MCP command (deprecated) | `src/mcp_code_intelligence/cli/commands/mcp.py` | 1-1183 |
| Init command | `src/mcp_code_intelligence/cli/commands/init.py` | (not analyzed) |
...
|-----------|-----------|---------------|
| Project Manager | `src/mcp_code_intelligence/core/project.py` | `detect_languages()`, `_detect_project_root()` |
| Database | `src/mcp_code_intelligence/core/database.py` | `_detect_and_recover_corruption()` |
| Indexer | `src/mcp_code_intelligence/core/indexer.py` | Uses monorepo detection |
| Monorepo Detector | `src/mcp_code_intelligence/utils/monorepo.py` | `detect_subprojects()` |
...
**Command**:
```bash
mcp-code-intelligence install --with-mcp --extensions .py,.js,.ts
```
...
**Command**:
```bash
mcp-code-intelligence install claude-code --watch
```
