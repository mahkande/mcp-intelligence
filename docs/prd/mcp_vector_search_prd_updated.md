...
mcp-code-intelligence init [--config CONFIG_FILE]

# Indexing operations  
mcp-code-intelligence index [--watch] [--incremental] [--extensions EXTS]
mcp-code-intelligence reindex [--force] [--path PATH]

# Search operations
mcp-code-intelligence search "authentication middleware" [--limit 10] [--files "*.py"]
mcp-code-intelligence similar --file src/auth.py --function login_handler
mcp-code-intelligence context "implement rate limiting" [--focus security,middleware]

# Project management
mcp-code-intelligence status [--verbose] [--health-check]
mcp-code-intelligence config [--show] [--set key=value] [--global]
mcp-code-intelligence clean [--cache] [--index] [--logs]

# Development and debugging
mcp-code-intelligence benchmark [--query-file QUERIES] [--report FORMAT]
mcp-code-intelligence explain --query "your search" [--debug]
mcp-code-intelligence validate [--index] [--config]
```
...
class ProjectConfig(BaseSettings):
    ...
    index_path: Path = Field(default=".mcp-code-intelligence", description="Index storage path")
...
class MCPVectorSearchError(Exception):
    """Base exception for MCP Code Intelligence."""
...
async def vector_db(
    ...
    db_path = temp_project_dir / ".mcp-code-intelligence"
...
def project_config(temp_project_dir: Path) -> ProjectConfig:
    ...
    return ProjectConfig(
        ...
        index_path=temp_project_dir / ".mcp-code-intelligence",
...
**Key Components**:
1. **Project Initialization**: `mcp-code-intelligence init` creates `.mcp-code-intelligence/` directory with configuration, sets up ChromaDB database, initializes Tree-sitter parsers
...
[project.urls]
Homepage = "https://github.com/yourusername/mcp-code-intelligence"
Documentation = "https://mcp-code-intelligence.readthedocs.io"
Repository = "https://github.com/yourusername/mcp-code-intelligence"
"Bug Tracker" = "https://github.com/yourusername/mcp-code-intelligence/issues"

[project.scripts]
mcp-code-intelligence = "mcp_code_intelligence.cli.main:app"

[tool.hatch.version]
path = "src/mcp_code_intelligence/__init__.py"

[tool.hatch.build.targets.wheel]
packages = ["src/mcp_code_intelligence"]
...
uv init mcp-code-intelligence --package
...
uv run mcp-code-intelligence init   # Test CLI
...
def main() -> None:
    ...
    print("🚀 Setting up mcp-code-intelligence development environment\n")
    ...
    print("\nNext steps:")
    print("  • Run 'uv run mcp-code-intelligence init' to initialize a test project")
