...
This directory contains product requirements documents (PRDs) and specifications for MCP Code Intelligence.

## 📋 Contents

### Product Requirements
- **[MCP Code Intelligence PRD](mcp_code_intelligence_prd_updated.md)** - Updated product requirements document
