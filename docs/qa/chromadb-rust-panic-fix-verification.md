...
**Test Execution**:
```bash
$ ./mcp-code-intelligence-dev index 2>&1 | head -50
ℹ Indexing project: /Users/masa/Projects/mcp-code-intelligence
...
Traceback (most recent call last):
  File "/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/database.py", line 170, in initialize
...
db_path = Path("/Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence")
...
```bash
$ uv run mypy src/mcp_code_intelligence/core/database.py
...
./mcp-code-intelligence-dev index
```

**Expected**:
- Either: Auto-recovery happens, indexing proceeds
- Or: Clear error message: "Database corrupted. Run: mcp-code-intelligence reset"

**NOT Expected**: Unhandled crash

### 2. Test Manual Recovery
```bash
mcp-code-intelligence reset --yes
./mcp-code-intelligence-dev index
```
...
```bash
mcp-code-intelligence search "database" --limit 3
```
...
**Date**: December 11, 2024
**Files Analyzed**:
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/database.py`
- `/Users/masa/Projects/mcp-code-intelligence/tests/unit/core/test_database.py`
- `/Users/masa/Projects/mcp-code-intelligence/tests/unit/core/test_corruption_recovery.py`
