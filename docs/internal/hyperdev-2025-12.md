...
Welcome to the December 2025 edition of HyperDev, where we explore the cutting edge of AI-powered development tools. This month, we're diving deep into **mcp-code-intelligence**—a CLI-first semantic code search tool that's evolving into a comprehensive code intelligence platform.
...
## What is mcp-code-intelligence?

**mcp-code-intelligence** is a CLI tool that brings semantic understanding to code search. Unlike traditional grep or regex-based search, it understands what your code *means*, not just what it *contains*.
...
# Chat with your code
mcp-code-intelligence chat "how does the login flow work?"
```
...
mcp-code-intelligence chat "how does caching work in this project?"

# Find mode (returns code)
mcp-code-intelligence chat "find the database connection pool"
```
...
mcp-code-intelligence setup --platform claude_desktop
```
...
```bash
# Coming soon
mcp-code-intelligence analyze --fail-on-smell --output sarif
```
...
| **Milestones** | https://github.com/bobmatnyc/mcp-code-intelligence/milestones |
| **Design Doc** | [structural-analysis-design.md](../research/mcp-code-intelligence-structural-analysis-design.md) |
...
# Search semantically
mcp-code-intelligence search "error handling patterns"

# Chat about your code
mcp-code-intelligence chat "explain the main architecture"
```
...
mcp-code-intelligence is evolving from a search tool into a code intelligence platform. By building with TkDD and Claude MPM, we're demonstrating how AI can orchestrate complex software projects while maintaining quality and traceability.
...
**Links**:
- GitHub: https://github.com/bobmatnyc/mcp-code-intelligence
- PyPI: https://pypi.org/project/mcp-code-intelligence/
- Project Board: https://github.com/users/bobmatnyc/projects/13
