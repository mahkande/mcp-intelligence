...
System architecture, design decisions, and technical deep dives for MCP Code Intelligence.

## 🏗️ Architecture Overview

MCP Code Intelligence follows a **layered, async-first architecture** designed for:
...
**Location**: `src/mcp_code_intelligence/cli/`
...
### Layer 2: MCP Server
**Location**: `src/mcp_code_intelligence/mcp/`
...
### Layer 3: Core Engine
**Location**: `src/mcp_code_intelligence/core/`
...
**Location**: `src/mcp_code_intelligence/parsers/`
...
### Layer 6: Utilities
**Location**: `src/mcp_code_intelligence/config/`, utilities
