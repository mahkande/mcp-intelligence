...
4. Users can install immediately: `brew install bobmatnyc/mcp-code-intelligence/mcp-code-intelligence`
...
### File Locations
- **Version Source**: `src/mcp_code_intelligence/__init__.py`
