...
The Homebrew integration automatically updates the formula in `bobmatnyc/homebrew-mcp-code-intelligence` whenever a new version is released to PyPI. This ensures Homebrew users always have access to the latest version.
...
4. Updates Formula/mcp-code-intelligence.rb
...
3. **Verify Formula:**
   ```bash
   brew info mcp-code-intelligence
   brew audit mcp-code-intelligence
   ```
...
- Verify package published: https://pypi.org/project/mcp-code-intelligence/
- Retry update
...
5. **Test formula locally:**
   ...
   brew audit mcp-code-intelligence
   brew install --build-from-source mcp-code-intelligence
   brew test mcp-code-intelligence
   ```
...
### External Resources
- [Homebrew Tap Repository](https://github.com/bobmatnyc/homebrew-mcp-code-intelligence)
