# MCP Code Intelligence - Visualization Architecture V2.0
...
**Target**: mcp-code-intelligence visualization module
...
**Test Projects**:
1. Small project (<100 files): mcp-code-intelligence itself
...
### Primary File: `/src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
...
**No changes required to**:
- `/src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py` (backend data generation)
- `/src/mcp_code_intelligence/cli/commands/visualize/templates/base.py` (HTML structure)
- `/src/mcp_code_intelligence/cli/commands/visualize/templates/styles.py` (CSS, minor additions only)
