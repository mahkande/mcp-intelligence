...
1. **Start visualization**:
   ...
   open .mcp-code-intelligence/visualization/index.html
   ```
...
- Users just need to update package: `pip install --upgrade mcp-code-intelligence`

---

## References

- **Source File**: `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
