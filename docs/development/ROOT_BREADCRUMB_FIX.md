...
Created comprehensive test: `/Users/masa/Projects/mcp-code-intelligence/tests/manual/test_root_breadcrumb_reset.py`
...
- **Implementation**: `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
