...
This document describes the enhanced corruption recovery implementation for handling ChromaDB Rust panic issues in mcp-code-intelligence.
...
**File**: `src/mcp_code_intelligence/core/exceptions.py`
...
RECOVERY COMPLETE - Next steps:
  1. Run 'mcp-code-intelligence index' to rebuild the index
...
### Recovery Process
1. Run `mcp-code-intelligence reset` to clear corrupted index
2. Run `mcp-code-intelligence index` to rebuild from source files
