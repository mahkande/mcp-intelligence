...
The `mcp-code-intelligence setup` command was not prompting for the OpenRouter API key during the setup flow. Users had to explicitly pass the `--save-api-key` flag to be prompted, which created a poor user experience.
...
🤖 Chat Command Setup (Optional)...
   ...
   ✅ API key saved to /path/to/.mcp-code-intelligence/config.json
...
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/config_utils.py`
- `/Users/masa/Projects/mcp-code-intelligence/tests/unit/commands/test_setup_api_key.py`
- `/Users/masa/Projects/mcp-code-intelligence/tests/manual/test_api_key_obfuscation.py`
