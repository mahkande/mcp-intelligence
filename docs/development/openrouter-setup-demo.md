...
Quick Start:
  1. Zero-config setup: mcp-code-intelligence setup (recommended!)
  2. Search code: mcp-code-intelligence search "your query"
  3. Check status: mcp-code-intelligence status
...
EXAMPLES:
  ...
  mcp-code-intelligence chat "how does auth work in this project?"
...
🚀 Ready to Use
  ...
  2. mcp-code-intelligence search 'your query' - Search your code
...
🚀 Ready to Use
  1. Open Claude Code in this directory to use MCP tools
  2. mcp-code-intelligence search 'your query' - Search your code
  3. mcp-code-intelligence chat 'question' - Ask AI about your code
  4. mcp-code-intelligence status - Check project status
...
```
User runs: mcp-code-intelligence setup
  ↓
Setup completes successfully
  ↓
User sees: mcp-code-intelligence search 'query' - Search your code
  ↓
User tries: mcp-code-intelligence chat "question"
  ↓
...
$ mcp-code-intelligence chat --help
...
> mcp-code-intelligence setup
> mcp-code-intelligence search "data pipeline"
✅ Works! Happy user.

[Next day]
User: "I heard there's a chat command, let me try it"
> mcp-code-intelligence chat "where is the ML model?"
❌ Error: OpenRouter API key not found
