...
MCP Code Intelligence maintains high code quality through automated linting, formatting, and type checking. This document outlines the tools and standards used.
...
[tool.ruff.isort]
known-first-party = ["mcp_code_intelligence"]
```
...
# Check specific file
uv run mypy src/mcp_code_intelligence/core/indexer.py
