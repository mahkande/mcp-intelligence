...
This document provides detailed API reference for MCP Code Intelligence internal modules. These APIs are intended for developers contributing to the project or building extensions.
...
**Location**: `src/mcp_code_intelligence/core/search.py`
...
**Location**: `src/mcp_code_intelligence/core/database.py`
...
**Location**: `src/mcp_code_intelligence/parsers/base.py`
...
**Location**: `src/mcp_code_intelligence/parsers/python.py`
...
**Location**: `src/mcp_code_intelligence/parsers/registry.py`
...
**Location**: `src/mcp_code_intelligence/core/models.py`
...
**Location**: `src/mcp_code_intelligence/config/settings.py`
...
class DatabaseSettings(BaseSettings):
    ...
    path: Path = Path(".mcp-code-intelligence/db")
    collection_name: str = "code_chunks"
...
**Location**: `src/mcp_code_intelligence/core/utils.py`
...
**Location**: `src/mcp_code_intelligence/core/embeddings.py`
...
**Location**: `src/mcp_code_intelligence/core/exceptions.py`

Custom exception classes.

```python
class MCPVectorSearchError(Exception):
    """Base exception for all MCP Code Intelligence errors."""
...
# 2. Register parser
from mcp_code_intelligence.parsers.registry import parser_registry
...
from mcp_code_intelligence.core.database import ChromaDatabase
from mcp_code_intelligence.core.embeddings import EmbeddingGenerator
from mcp_code_intelligence.parsers.registry import parser_registry

# Initialize components
database = ChromaDatabase(Path(".mcp-code-intelligence/db"))
embeddings = EmbeddingGenerator()
indexer = SemanticIndexer(database, embeddings, parser_registry)
...
```python
from mcp_code_intelligence.core.search import SemanticSearch
