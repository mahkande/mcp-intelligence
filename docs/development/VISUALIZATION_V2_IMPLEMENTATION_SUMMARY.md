...
**Files Modified**:
- `src/mcp_code_intelligence/cli/commands/visualize/state_manager.py` (Python)
- `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py` (JavaScript `StateManager` class)
...
**Files Created**:
- `src/mcp_code_intelligence/cli/commands/visualize/layout_engine.py` (Python backend)

**Files Modified**:
- `src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py` (JavaScript frontend)
...
### Files Created (2):
1. `src/mcp_code_intelligence/cli/commands/visualize/layout_engine.py` (275 lines)
...
**Date**: December 6, 2025
**Version**: mcp-code-intelligence V2.0
