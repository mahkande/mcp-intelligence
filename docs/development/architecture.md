...
**Comprehensive development guide for MCP Code Intelligence contributors and maintainers**
...
MCP Code Intelligence follows a **layered, async-first architecture** with these core principles:
...
### 🎯 CLI Layer (`src/mcp_code_intelligence/cli/`)
...
### 🔍 Core Engine (`src/mcp_code_intelligence/core/`)
...
### 🔧 Parser System (`src/mcp_code_intelligence/parsers/`)
...
### 🔌 MCP Integration (`src/mcp_code_intelligence/mcp/`)
...
- **Source of Truth**: `src/mcp_code_intelligence/__init__.py`
...
from mcp_code_intelligence.utils.timing import timing_decorator
...
*This document is optimized for developers working on MCP Code Intelligence. For AI agent instructions, see [CLAUDE.md](CLAUDE.md).*
