...
### Quality Checks
```bash
✅ uv run ruff check src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py
✅ uv run black src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py --check
✅ uv run mypy src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py
