...
- `/src/mcp_code_intelligence/cli/commands/visualize/templates/base.py` (D3.js already present)
...
### Syntax Validation
```bash
python3 -m py_compile src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py
...
- [ ] **Tree Layout Displays**
  - Run: `mcp-code-intelligence visualize`
...
1. **Run visualization**: `mcp-code-intelligence visualize`
