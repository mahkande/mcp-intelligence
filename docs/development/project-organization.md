...
**MCP Code Intelligence - File Organization Rules**
...
│   └── mcp_code_intelligence/    # Main package
...
| Product | `docs/prd/` | Requirements | `mcp_code_intelligence_prd.md` |
...
- **Utility Scripts**: `kebab-case.sh` (e.g., `mcp-code-intelligence.sh`)

#### Directories
- **Package Directories**: `snake_case/` (e.g., `mcp_code_intelligence/`)
- **Doc Categories**: `lowercase/` (e.g., `developer/`, `reference/`)

### Import Conventions
```python
# Absolute imports from src/
from mcp_code_intelligence.core.search import VectorSearch
...
#### Configuration Files
```
.mcp-code-intelligence/      # Per-project config (git-ignored)
...
git mv mcp-code-intelligence.sh scripts/setup/
```
