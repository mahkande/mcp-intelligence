...
Comprehensive testing guide for mcp-code-intelligence covering unit tests, integration tests, end-to-end tests, and performance testing.

## 🎯 Testing Philosophy

MCP Code Intelligence follows a comprehensive testing strategy to ensure reliability, performance, and maintainability. Our testing approach prioritizes the most critical functions with appropriate test coverage and quality metrics.
...
from mcp_code_intelligence.core.models import ChunkType
...
''')
            ...
            assert Path(".mcp-code-intelligence").exists()
            ...
            # Search code
            result = subprocess.run(
                ["mcp-code-intelligence", "search", "main function"],
                capture_output=True,
                text=True
            )
            assert result.returncode == 0
...
uv run pytest --cov=src/mcp_code_intelligence

# Generate HTML coverage report
uv run pytest --cov=src/mcp_code_intelligence --cov-report=html

# View coverage report
open htmlcov/index.html

# Fail if coverage below threshold
uv run pytest --cov=src/mcp_code_intelligence --cov-fail-under=80
```
...
The MCP Code Intelligence project has a world-class test suite that:
...
This test suite ensures the reliability, performance, and maintainability of the MCP Code Intelligence project, giving users and developers confidence in the software quality.
