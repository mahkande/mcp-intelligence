...
uv run mypy src/mcp_code_intelligence/analysis/metrics.py

# Code coverage ≥80%
uv run pytest --cov=src/mcp_code_intelligence/analysis
```
...
**Issues**: https://github.com/bobmatnyc/mcp-code-intelligence/issues
...
git pull
git checkout -b feature/2-metric-dataclasses
code src/mcp_code_intelligence/analysis/metrics.py
```
