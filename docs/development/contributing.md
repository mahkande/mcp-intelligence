# Contributing to MCP Code Intelligence

## 🎯 Welcome Contributors!

Thank you for your interest in contributing to MCP Code Intelligence! This guide will help you get started with contributing to the project.
...
git clone https://github.com/YOUR_USERNAME/mcp-code-intelligence.git
...
### Before Reporting
1. Check existing [issues](https://github.com/bobmatnyc/mcp-code-intelligence/issues)
...
- OS: [e.g., macOS 14.0]
- Python: [e.g., 3.11.5]
- mcp-code-intelligence: [e.g., 0.0.3]
...
Your contributions make MCP Code Intelligence better for everyone. Whether you're fixing bugs, adding features, improving documentation, or helping other users, every contribution is valuable and appreciated!

For questions about contributing, feel free to open a [discussion](https://github.com/bobmatnyc/mcp-code-intelligence/discussions) or reach out through GitHub issues.
