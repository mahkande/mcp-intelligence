...
- Working with multiple projects (e.g., EDGAR vs mcp-code-intelligence)
...
Enhanced `mcp-code-intelligence install mcp` command with automatic project path detection that:
...
- `detect_project_root(start_path: Path | None = None) -> Path`
  - Auto-detects project root via `.mcp-code-intelligence/` directory or git root
...
### 2. `/src/mcp_code_intelligence/mcp/server.py`
...
1. `TestProjectRootDetection` - 4 tests
   - Detection via `.mcp-code-intelligence/` directory
   - Detection via git root + `.mcp-code-intelligence/`
   - Fallback to current directory
   - Preference of local `.mcp-code-intelligence/` over git root
...
def detect_project_root(start_path: Path | None = None) -> Path:
    ...
    # Priority 1: .mcp-code-intelligence in current directory
    if (current / ".mcp-code-intelligence").exists():
        return current

    # Priority 2: Git root with .mcp-code-intelligence
...
mcp-code-intelligence init
mcp-code-intelligence install mcp  # Auto-detects project root
# Done! ✅
```
...
### New Commands
- `mcp-code-intelligence install mcp [--auto]` - Install with auto-detection (default)
- `mcp-code-intelligence install mcp --no-auto` - Install without auto-detection
- `mcp-code-intelligence install mcp-status` - Show MCP configuration status
...
- `mcp-code-intelligence install mcp --dry-run` - Preview without changes
...
- [ ] Support for `.mcp-root` marker file (alternative to `.mcp-code-intelligence/`)
...
**Modified Files**:
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/install.py` (lines 91-144, 462-517, 652-744)
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/mcp/server.py` (lines 33-74)

**New Files**:
- `/Users/masa/Projects/mcp-code-intelligence/tests/unit/test_mcp_install_auto_detection.py`
- `/Users/masa/Projects/mcp-code-intelligence/tests/manual/test_mcp_auto_install.sh`
- `/Users/masa/Projects/mcp-code-intelligence/docs/guides/MCP_AUTO_INSTALLATION.md`
- `/Users/masa/Projects/mcp-code-intelligence/docs/development/MCP_AUTO_INSTALLATION_IMPLEMENTATION.md`
