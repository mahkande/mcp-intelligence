...
gh issue view <issue-number> --repo bobmatnyc/mcp-code-intelligence
```
...
```bash
# List ready issues
gh issue list --repo bobmatnyc/mcp-code-intelligence \
  --label "enhancement" \
...
- [Design Document](../research/mcp-code-intelligence-structural-analysis-design.md)
