...
Enhanced the `mcp-code-intelligence setup` command to automatically check for OpenRouter API key configuration and provide clear setup instructions when the key is not found. This improves the onboarding experience for users who want to use the chat command.

## Changes Made

### 1. Added OpenRouter API Key Check Function

**File**: `src/mcp_code_intelligence/cli/commands/setup.py`
...
**File**: `src/mcp_code_intelligence/cli/main.py`
...
**New Help Structure**:
```
🔍 MCP Code Intelligence - Semantic Code Search CLI
...
🚀 Ready to Use
  1. mcp-code-intelligence search 'your query' - Search your code
  2. mcp-code-intelligence status - Check project status
```
...
🚀 Ready to Use
  1. mcp-code-intelligence search 'your query' - Search your code
  2. mcp-code-intelligence chat 'question' - Ask AI about your code
  3. mcp-code-intelligence status - Check project status
```
...
```bash
# Formatting
$ uv run black src/mcp_code_intelligence/cli/commands/setup.py src/mcp_code_intelligence/cli/main.py --check
All done! ✨ 🍰 ✨
2 files would be left unchanged.

# Linting
$ uv run ruff check src/mcp_code_intelligence/cli/commands/setup.py src/mcp_code_intelligence/cli/main.py
All checks passed!

# Type Checking
$ uv run mypy src/mcp_code_intelligence/cli/commands/setup.py --ignore-missing-imports
Success: no issues found
```

## Files Modified

1. **src/mcp_code_intelligence/cli/commands/setup.py**
...
2. **src/mcp_code_intelligence/cli/main.py**
