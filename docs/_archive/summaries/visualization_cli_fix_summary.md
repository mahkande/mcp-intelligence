...
- **Old**: `/src/mcp_code_intelligence/cli/commands/visualize.py` (monolithic)
- **New**: `/src/mcp_code_intelligence/cli/commands/visualize/` (modular)
...
```
ImportError: cannot import name 'app' from 'mcp_code_intelligence.cli.commands.visualize'
```

### Symptoms
1. ❌ `mcp-code-intelligence visualize --help` crashed with import error
...
### ✅ Import Test
```bash
$ uv run python -c "from mcp_code_intelligence.cli.commands.visualize import app; print('Import successful')"
✅ Import successful
```

### ✅ CLI Command Test
```bash
$ uv run mcp-code-intelligence visualize --help
Usage: mcp-code-intelligence visualize [OPTIONS] COMMAND [ARGS]...
...
```bash
$ grep -c "positionNodesCompactly" .mcp-code-intelligence/visualization/index.html
...
def test_visualize_app_import():
    from mcp_code_intelligence.cli.commands.visualize import app
...
- ✅ `mcp-code-intelligence visualize --help` works
