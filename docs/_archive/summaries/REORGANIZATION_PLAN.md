...
This document outlines the complete reorganization of the mcp-code-intelligence documentation to create a clear, user-friendly structure that separates concerns and improves navigation.
...
#### `/docs/prd/` (1 file)
- `mcp_code_intelligence_prd_updated.md` - Product requirements (64KB - large)
...
| `docs/prd/mcp_code_intelligence_prd_updated.md` | Keep in prd/ | Product docs (separate from user docs) |
