...
Successfully integrated git submodule management into the MCP Code Intelligence project's build and release system. The submodule (`vendor/py-mcp-installer-service`) is now properly synced, tested, and included in all CI/CD workflows.
...
**Created**: `/Users/masa/Projects/mcp-code-intelligence/scripts/update_submodules.sh`
