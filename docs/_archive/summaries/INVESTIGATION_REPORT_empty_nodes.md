...
```bash
$ python3 -c "import json; data = json.load(open('.mcp-code-intelligence/visualization/chunk-graph.json')); print(f'Nodes: {len(data[\"nodes\"])}'); print(f'Links: {len(data[\"links\"])}')"
Nodes: 1449
Links: 360825
```
...
**File**: `.mcp-code-intelligence/visualization/index.html`
