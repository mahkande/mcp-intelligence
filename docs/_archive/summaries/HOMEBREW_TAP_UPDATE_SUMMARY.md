...
- https://github.com/bobmatnyc/homebrew-mcp-code-intelligence
...
```bash
ruby -c Formula/mcp-code-intelligence.rb
```
...
mcp-code-intelligence --version  # Should show 0.14.3
```

### 3. Verify on GitHub
Check the commit in the tap repository:
https://github.com/bobmatnyc/homebrew-mcp-code-intelligence/commits/main
...
1. Check availability: https://pypi.org/project/mcp-code-intelligence/0.14.3/
