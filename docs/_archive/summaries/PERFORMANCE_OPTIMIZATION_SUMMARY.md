...
**File:** `src/mcp_code_intelligence/core/indexer.py` - `_scan_files_sync()`
...
**File:** `src/mcp_code_intelligence/core/indexer.py` - `_should_index_file()`
...
1. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/utils/gitignore.py`
   - Updated `is_ignored()` method signature
   - Updated `is_path_gitignored()` helper function

2. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/indexer.py`
...
3. `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/core/project.py`
   - Updated `_should_ignore_path()` method signature
