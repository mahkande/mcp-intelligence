...
This document summarizes the comprehensive reorganization of MCP Code Intelligence documentation completed on 2025-11-15.
...
### Keep As-Is
- `prd/mcp_code_intelligence_prd_updated.md` - Product docs (separate)
