...
### 1. `/src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
...
### 2. `/src/mcp_code_intelligence/cli/commands/visualize/templates/styles.py`
...
1. ✅ Generate visualization: `mcp-code-intelligence visualize export`
2. ✅ Regenerate HTML: `uv run python3 -c "from mcp_code_intelligence.cli.commands.visualize.exporters.html_exporter import export_to_html; from pathlib import Path; export_to_html(Path('.mcp-code-intelligence/visualization/index.html'))"`
...
### Test Results
```bash
✓ Created visualization HTML at .mcp-code-intelligence/visualization/index.html
Size: 90055 bytes
...
### For Users
1. Open visualization: `mcp-code-intelligence visualize serve`
...
# Remove old HTML
rm .mcp-code-intelligence/visualization/index.html
