...
============================================================
Homebrew Formula Updater for mcp-code-intelligence
============================================================

ℹ Fetching package information from PyPI...
✓ Found version: 0.12.7
ℹ Tap repository exists at /Users/user/.homebrew_tap_update/homebrew-mcp-code-intelligence
[DRY RUN] Would pull latest changes
ℹ Updating formula: mcp-code-intelligence.rb
...
brew install --build-from-source bobmatnyc/mcp-code-intelligence/mcp-code-intelligence
...
mcp-code-intelligence init --extensions .py --embedding-model sentence-transformers/all-MiniLM-L6-v2
...
rm -rf ~/.homebrew_tap_update/homebrew-mcp-code-intelligence
...
- ✅ Run `brew audit mcp-code-intelligence`
...
- **Homebrew Tap:** https://github.com/bobmatnyc/homebrew-mcp-code-intelligence
- **PyPI Package:** https://pypi.org/project/mcp-code-intelligence/
...
export HOMEBREW_TAP_REPO="https://github.com/bobmatnyc/homebrew-mcp-code-intelligence.git"
```
...
**Version:** 1.0.0
**Maintainer:** MCP Code Intelligence Team
