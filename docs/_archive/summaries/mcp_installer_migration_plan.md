...
**Location**: `/Users/masa/Projects/mcp-code-intelligence/pyproject.toml`
...
**Location**: `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/install.py`
...
[bold cyan]Usage:[/bold cyan]
  $ mcp-code-intelligence install              # Auto-detect and install
  $ mcp-code-intelligence install --dry-run    # Preview changes
  $ mcp-code-intelligence install --all        # Install to all platforms
""",
...
async def install_mcp_server(
    ...
    """Install mcp-code-intelligence to MCP-compatible platforms."""
    ...
    try:
        ...
        server_config = ServerConfig(
            command="uv",
            args=["run", "--directory", str(project_root), "mcp-code-intelligence"],
            env={
...
def init(
    ...
    """Initialize mcp-code-intelligence in current project."""
...
**Location**: `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/uninstall.py`

**New Implementation**:

```python
"""Uninstall commands for MCP Code Intelligence CLI."""
...
uninstall_app = typer.Typer(help="Uninstall mcp-code-intelligence from MCP platforms")
...
async def mcp(
    ...
    """Uninstall mcp-code-intelligence from MCP platforms."""
...
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/install_old.py`
...
1. `/Users/masa/Projects/mcp-code-intelligence/tests/unit/commands/test_setup.py`
2. `/Users/masa/Projects/mcp-code-intelligence/tests/integration/test_setup_integration.py`
...
async def test_install_server_success():
    ...
    with patch.object(MCPInstaller, 'install_server') as mock_install:
        ...
        config = ServerConfig(command="uv", args=["run", "mcp-code-intelligence"])
...
mcp-code-intelligence install mcp --platform claude-desktop
...
# Test validation
mcp-code-intelligence install mcp --validate
```
...
- Related files:
  - Current install.py: `src/mcp_code_intelligence/cli/commands/install.py`
  - Current uninstall.py: `src/mcp_code_intelligence/cli/commands/uninstall.py`
