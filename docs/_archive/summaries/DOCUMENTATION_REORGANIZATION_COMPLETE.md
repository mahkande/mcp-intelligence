...
The mcp-code-intelligence documentation has been comprehensively reorganized to create a clear, user-friendly structure with better navigation and separation between user and developer documentation.
...
│
├── prd/                             📋 Unchanged
│   └── mcp_code_intelligence_prd_updated.md
│
