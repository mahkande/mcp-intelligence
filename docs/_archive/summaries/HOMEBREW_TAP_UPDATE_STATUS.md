...
curl -s https://pypi.org/pypi/mcp-code-intelligence/json | \
  python3 -c "import sys, json; print(json.load(sys.stdin)['info']['version'])"
# Output: 0.14.2

# Check target version
curl -s https://pypi.org/pypi/mcp-code-intelligence/0.14.3/json
...
# Version in source
grep __version__ src/mcp_code_intelligence/__init__.py
...
1. **Verify PyPI Upload**
   ...
   curl -s https://pypi.org/project/mcp-code-intelligence/0.14.3/
   ```
...
cd homebrew-mcp-code-intelligence

# 2. Get SHA256 from PyPI
PYPI_SHA256=$(curl -s https://pypi.org/pypi/mcp-code-intelligence/0.14.3/json | \
...
sed -i '' "s/version \"[^\"]*\"/version \"0.14.3\"/g" Formula/mcp-code-intelligence.rb
sed -i '' "s/sha256 \"[^\"]*\"/sha256 \"$PYPI_SHA256\"/g" Formula/mcp-code-intelligence.rb

# 4. Verify changes
git diff Formula/mcp-code-intelligence.rb

# 5. Commit and push
git add Formula/mcp-code-intelligence.rb
...
1. **PyPI Package Available**
   - Users can still install via: `pip install mcp-code-intelligence`
...
```bash
/Users/masa/Projects/mcp-code-intelligence/
├── scripts/
...
1. **Check PyPI:** https://pypi.org/project/mcp-code-intelligence/0.14.3/
