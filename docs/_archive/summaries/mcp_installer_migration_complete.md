...
📦 Would install to: Claude Code
   Config: /Users/masa/Projects/mcp-code-intelligence/.mcp.json
   Changes:
     + Add server: mcp-code-intelligence
     + Command: uv run mcp-code-intelligence
```
...
### ✅ CLI Command Tests
```bash
$ uv run mcp-code-intelligence install --help
✓ Help displays correctly

$ mcp-code-intelligence install mcp --help
✓ MCP subcommand works

$ mcp-code-intelligence install list-platforms
✓ Platform detection works

$ mcp-code-intelligence uninstall mcp --help
...
git checkout HEAD -- src/mcp_code_intelligence/cli/commands/install.py
git checkout HEAD -- src/mcp_code_intelligence/cli/commands/uninstall.py
