...
Instead of the expected correct path from the actual project root (mcp-code-intelligence).
...
### Analysis
While the breadcrumb correctly maintains "🏠 Root" at the beginning, the paths displayed are incorrect. The breadcrumb shows "tests/manual" as if it's the complete path from the project root, when it should show the actual file paths relative to mcp-code-intelligence.
...
2. **File**: `/Users/masa/Projects/mcp-code-intelligence/tests/manual/package.json`
   ```json
   {
     "name": "manual",
     "version": "1.0.0",
...
The JavaScript fix applied earlier removed logic that tried to strip 'mcp-code-intelligence' from paths. However, this fix cannot solve the problem because:
...
- **Location**: `src/mcp_code_intelligence/utils/monorepo.py` - Monorepo detection logic
- **Location**: `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py` - Subproject node creation
...
- **Action**: Delete `/Users/masa/Projects/mcp-code-intelligence/tests/manual/package.json`
...
- **File**: `src/mcp_code_intelligence/utils/monorepo.py`
...
- **File**: `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py`
- **Logic**:
  ```python
...
- **Test Script**: `/Users/masa/Projects/mcp-code-intelligence/tests/manual/test_breadcrumb_fix.py`
- **Test Results**: `/Users/masa/Projects/mcp-code-intelligence/tests/manual/breadcrumb_test_results.json`
- **Screenshots**: `/Users/masa/Projects/mcp-code-intelligence/tests/manual/screenshots/`
...
3. **Re-index Project**: Run `mcp-code-intelligence index` to regenerate data
4. **Re-run Visualization**: Run `mcp-code-intelligence visualize` to regenerate graph
