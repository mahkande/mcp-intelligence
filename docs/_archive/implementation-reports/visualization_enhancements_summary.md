...
### Implementation
- **File**: `src/mcp_code_intelligence/cli/commands/visualize/templates/styles.py` (Lines: 70-120)
- **File**: `src/mcp_code_intelligence/cli/commands/visualize/templates/base.py` (Lines: 36-141)
...
3. `src/mcp_code_intelligence/cli/commands/visualize/templates/base.py`
