...
├── src/mcp_code_intelligence/          # Main package source
...
**Location**: `src/mcp_code_intelligence/config/`
...
- **`.mcp-code-intelligence/config.yaml`** - User settings
- **`.mcp-code-intelligence/db/`** - Vector database storage
