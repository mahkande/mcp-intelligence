...
## Testing
To verify:
1. Run `mcp-code-intelligence visualize`
...
## Related Files
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize/templates/styles.py` - CSS theme colors
- `/Users/masa/Projects/mcp-code-intelligence/src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py` - D3 visualization logic
