...
This document summarizes the GitHub issues created for implementing the Structural Code Analysis feature in mcp-code-intelligence, based on the design document located at `docs/research/mcp-code-intelligence-structural-analysis-design.md`.
...
### [Epic 1: Core Metrics - Phase 1](https://github.com/bobmatnyc/mcp-code-intelligence/issues/1)

**Timeline**: Week 1-2
**Focus**: Tier 1 collectors integrated into indexer with basic analysis command

**Issues**:
1. [#2 - Create metric dataclasses and interfaces](https://github.com/bobmatnyc/mcp-code-intelligence/issues/2)
2. [#3 - Implement Cognitive Complexity Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/3)
3. [#4 - Implement Cyclomatic Complexity Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/4)
4. [#5 - Implement Nesting Depth Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/5)
5. [#6 - Implement Parameter Count Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/6)
6. [#7 - Implement Method Count Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/7)
7. [#8 - Integrate collectors with existing TreeSitter indexer](https://github.com/bobmatnyc/mcp-code-intelligence/issues/8)
8. [#9 - Extend ChromaDB metadata schema](https://github.com/bobmatnyc/mcp-code-intelligence/issues/9)
9. [#10 - Create analyze --quick CLI command](https://github.com/bobmatnyc/mcp-code-intelligence/issues/10)
10. [#11 - Implement console reporter](https://github.com/bobmatnyc/mcp-code-intelligence/issues/11)
...
### [Epic 2: Quality Gates - Phase 2](https://github.com/bobmatnyc/mcp-code-intelligence/issues/12)

**Timeline**: Week 3
**Focus**: Threshold configuration, CI integration, and diff-aware analysis

**Issues**:
1. [#13 - Create threshold configuration system](https://github.com/bobmatnyc/mcp-code-intelligence/issues/13)
2. [#14 - Implement code smell detection](https://github.com/bobmatnyc/mcp-code-intelligence/issues/14)
3. [#15 - Add SARIF output format](https://github.com/bobmatnyc/mcp-code-intelligence/issues/15)
4. [#16 - Implement --fail-on-smell exit codes](https://github.com/bobmatnyc/mcp-code-intelligence/issues/16)
5. [#17 - Add diff-aware analysis](https://github.com/bobmatnyc/mcp-code-intelligence/issues/17)
6. [#18 - Add baseline comparison](https://github.com/bobmatnyc/mcp-code-intelligence/issues/18)
...
### [Epic 3: Cross-File Analysis - Phase 3](https://github.com/bobmatnyc/mcp-code-intelligence/issues/19)

**Timeline**: Week 4
**Focus**: Tier 4 collectors for coupling analysis and dependency tracking

**Issues**:
1. [#20 - Implement Efferent Coupling Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/20)
2. [#21 - Implement Afferent Coupling Collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/21)
3. [#22 - Calculate Instability Index](https://github.com/bobmatnyc/mcp-code-intelligence/issues/22)
4. [#23 - Implement circular dependency detection](https://github.com/bobmatnyc/mcp-code-intelligence/issues/23)
5. [#24 - Create SQLite metrics store](https://github.com/bobmatnyc/mcp-code-intelligence/issues/24)
6. [#25 - Implement trend tracking](https://github.com/bobmatnyc/mcp-code-intelligence/issues/25)
7. [#26 - Implement LCOM4 cohesion metric](https://github.com/bobmatnyc/mcp-code-intelligence/issues/26)
...
### [Epic 4: Visualization Export - Phase 4](https://github.com/bobmatnyc/mcp-code-intelligence/issues/27)

**Timeline**: Week 5
**Focus**: JSON export schemas and visualization data for charts/graphs

**Issues**:
1. [#28 - Design visualization JSON export schema](https://github.com/bobmatnyc/mcp-code-intelligence/issues/28)
2. [#29 - Implement JSON exporter](https://github.com/bobmatnyc/mcp-code-intelligence/issues/29)
3. [#30 - Create HTML standalone report](https://github.com/bobmatnyc/mcp-code-intelligence/issues/30)
4. [#31 - Implement Halstead metrics collector](https://github.com/bobmatnyc/mcp-code-intelligence/issues/31)
5. [#32 - Add technical debt estimation](https://github.com/bobmatnyc/mcp-code-intelligence/issues/32)
6. [#33 - Extend status command with metrics](https://github.com/bobmatnyc/mcp-code-intelligence/issues/33)
...
### [Epic 5: Search Integration - Phase 5 (Future)](https://github.com/bobmatnyc/mcp-code-intelligence/issues/34)

**Timeline**: Future/Backlog
**Focus**: Quality-aware search ranking and filtering

**Issues**:
1. [#35 - Add quality filters to search](https://github.com/bobmatnyc/mcp-code-intelligence/issues/35)
2. [#36 - Implement quality-aware ranking](https://github.com/bobmatnyc/mcp-code-intelligence/issues/36)
3. [#37 - Expose analysis as MCP tools](https://github.com/bobmatnyc/mcp-code-intelligence/issues/37)
...
- **Repository**: https://github.com/bobmatnyc/mcp-code-intelligence
- **All Issues**: https://github.com/bobmatnyc/mcp-code-intelligence/issues
- **Design Document**: `docs/research/mcp-code-intelligence-structural-analysis-design.md`
