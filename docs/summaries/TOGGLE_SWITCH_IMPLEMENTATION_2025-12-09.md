...
1. `/src/mcp_code_intelligence/cli/commands/visualize/templates/base.py`
...
3. `/src/mcp_code_intelligence/cli/commands/visualize/templates/scripts.py`
...
rm /Users/masa/Projects/mcp-code-intelligence/.mcp-code-intelligence/visualization/index.html

# 2. Restart server (will regenerate HTML from templates)
lsof -ti:8080 | xargs kill -9
uv run mcp-code-intelligence visualize serve --port 8080
```
