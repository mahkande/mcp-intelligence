...
mcp-code-intelligence analyze --inspect-baseline main-branch
```
...
**Location**: `~/.mcp-code-intelligence/baselines/`
...
| **Storage Location** | `~/.mcp-code-intelligence/baselines/` |
...
mcp-code-intelligence analyze --save-baseline "main-$(date +%Y-%m-%d)"

# Compare PR branch against main baseline
mcp-code-intelligence analyze --compare-baseline main-branch --fail-on-regression
```
...
**New files**:
- `src/mcp_code_intelligence/analysis/baseline/manager.py`
- `src/mcp_code_intelligence/analysis/baseline/comparator.py`
