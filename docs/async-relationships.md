...
$ mcp-code-intelligence visualize
...
**File:** `src/mcp_code_intelligence/core/relationships.py`
...
$ mcp-code-intelligence index relationships

# Compute in background (non-blocking)
$ mcp-code-intelligence index relationships --background
```

### 4. Background Worker Support

**File:** `src/mcp_code_intelligence/cli/commands/index_background.py`
...
```bash
python -m mcp_code_intelligence.cli.commands.index_background \
...
**Graph Builder** (`src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py`):
...
**Old workflow:**
```bash
$ mcp-code-intelligence index  # Waits 5-10 min
$ mcp-code-intelligence visualize serve
```

**New workflow (instant visualization):**
```bash
$ mcp-code-intelligence index  # Returns in 30s
$ mcp-code-intelligence visualize serve  # Start immediately
...
```bash
$ mcp-code-intelligence index  # Returns in 30s
$ mcp-code-intelligence index relationships  # Compute now (5-10 min)
$ mcp-code-intelligence visualize serve  # Full visualization
```
...
- `src/mcp_code_intelligence/core/relationships.py` - Relationship computation
- `src/mcp_code_intelligence/core/indexer.py` - Indexing with background mode
- `src/mcp_code_intelligence/cli/commands/index.py` - CLI commands
- `src/mcp_code_intelligence/cli/commands/index_background.py` - Background worker
- `src/mcp_code_intelligence/cli/commands/visualize/graph_builder.py` - Visualization
