...
This directory contains documentation for configuring MCP Code Intelligence projects and environments.
...
- **Project Settings** - `.mcp-code-intelligence/config.json` configuration
