# MCP Code Intelligence Documentation

Welcome to the comprehensive documentation for **MCP Code Intelligence** - a CLI-first semantic code search tool with MCP integration.
...
- [Extending MCP Code Intelligence](advanced/extending.md) - Add languages, parsers, etc.
