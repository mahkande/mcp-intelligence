...
if TYPE_CHECKING:
    from mcp_code_intelligence.analysis.collectors.smells import CodeSmell
...
class MarkdownReporter:
    ...
    def generate_analysis_report(
        ...
        output_file = output_dir / "mcp-code-intelligence-analysis.md"
    ...
    def generate_fixes_report(
        ...
        output_file = output_dir / "mcp-code-intelligence-analysis-fixes.md"
    ...
    def _build_analysis_markdown(
        ...
        # Header
        lines.append("# MCP Code Intelligence - Code Analysis Report")
        ...
        lines.append("---")
        lines.append("")
        lines.append("*Generated by mcp-code-intelligence analyze command*")
        lines.append("")
    ...
    def _build_fixes_markdown(
        ...
        # Header
        lines.append("# MCP Code Intelligence - Refactoring Tasks")
        lines.append("")
        lines.append(f"Generated: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        lines.append("")
        lines.append(
