...
Example:
    ...
    >>> from mcp_code_intelligence.analysis.visualizer import JSONExporter, HTMLReportGenerator
    >>>
...
from mcp_code_intelligence.analysis.visualizer.d3_data import transform_for_d3
from mcp_code_intelligence.analysis.visualizer.schemas import AnalysisExport
...
<header>
    ...
    def _generate_footer(self, export: AnalysisExport) -> str:
        ...
        """
        return f"""<footer>
    <p>Generated by mcp-code-intelligence v{export.metadata.tool_version}</p>
