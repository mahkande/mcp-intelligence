...
Design Decisions:
    ...
    - Storage location: ~/.mcp-code-intelligence/baselines/ by default
    ...
    def __init__(self, storage_dir: Path | None = None):
        ...
        Args:
            storage_dir: Optional custom storage directory.
                        Defaults to ~/.mcp-code-intelligence/baselines/
        """
        if storage_dir is None:
            # Default storage location
            storage_dir = Path.home() / ".mcp-code-intelligence" / "baselines"
