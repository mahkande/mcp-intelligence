...
Design Decisions:
    Storage Location: ~/.mcp-code-intelligence/metrics.db by default
...
from mcp_code_intelligence.utils.version import get_version_string
from mcp_code_intelligence.analysis.metrics import FileMetrics, ProjectMetrics
from mcp_code_intelligence.analysis.storage.schema import INIT_SCHEMA_SQL, SCHEMA_VERSION, get_schema_version_query
...
class ProjectSnapshot:
    ...
    Attributes:
        ...
        tool_version: Version of mcp-code-intelligence used
    """
    ...
    def __init__(self, db_path: Path | None = None):
        ...
        Args:
            db_path: Optional custom database path.
                    Defaults to ~/.mcp-code-intelligence/metrics.db
        ...
        if db_path is None:
            ...
            storage_dir = Path.home() / ".mcp-code-intelligence"
