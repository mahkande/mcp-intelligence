...
Example Usage:
    >>> from mcp_code_intelligence.analysis.storage import MetricsStore
    >>> from mcp_code_intelligence.analysis.metrics import ProjectMetrics
    >>>
    >>> # Initialize store (uses default ~/.mcp-code-intelligence/metrics.db)
    >>> store = MetricsStore()
    >>>
...
from mcp_code_intelligence.analysis.storage.metrics_store import (
    DatabaseLockedError,
    DuplicateEntryError,
    GitInfo,
    MetricsStore,
...
from mcp_code_intelligence.analysis.storage.schema import SCHEMA_VERSION
from mcp_code_intelligence.analysis.storage.trend_tracker import (
    FileRegression,
    TrendDirection,
    TrendTracker,
)
