"""Version utilities for MCP Code Intelligence.
...
from mcp_code_intelligence import __author__, __build__, __email__, __version__
...
def get_user_agent() -> str:
    ...
    """
    return f"mcp-code-intelligence/{__version__}"
