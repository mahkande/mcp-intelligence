...
def ensure_gitignore_entry(
    ...
    requirement for mcp-code-intelligence functionality. Users can manually add
    the entry if automatic update fails.

    Pattern Detection Strategy
    --------------------------
    The function checks for semantic equivalents of the pattern:
    - `.mcp-code-intelligence/` (exact match)
    ...
    Args:
        ...
        pattern: Pattern to add to .gitignore (default: .mcp-code-intelligence/)
        ...
        for line in lines:
            ...
            if stripped_line.startswith("!") and normalized_pattern in stripped_line:
                logger.warning(
                    ...
                    "This indicates you want to track .mcp-code-intelligence/ in git. "
