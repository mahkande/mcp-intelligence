"""Custom exception hierarchy for MCP Code Intelligence."""

from typing import Any


class MCPCodeIntelligenceError(Exception):
...
class DatabaseError(MCPCodeIntelligenceError):
...
class ParsingError(MCPCodeIntelligenceError):
    """Code parsing errors."""

    pass


class EmbeddingError(MCPCodeIntelligenceError):
    """Embedding generation errors."""

    pass


class ConfigurationError(MCPCodeIntelligenceError):
    """Configuration validation errors."""

    pass


class ProjectError(MCPCodeIntelligenceError):
