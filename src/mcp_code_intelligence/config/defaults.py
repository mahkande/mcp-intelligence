"""Default configurations for MCP Code Intelligence."""
...
DEFAULT_EMBEDDING_MODELS = {
    "code": "jinaai/jina-embeddings-v3",
    "multilingual": "jinaai/jina-embeddings-v3",
    "fast": "sentence-transformers/all-MiniLM-L6-v2",
    "precise": "jinaai/jina-embeddings-v3",
}
