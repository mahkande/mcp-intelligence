"""Demo command for mcp-code-intelligence."""
...
from mcp_code_intelligence.cli.output import print_error, print_info, print_success
...
def demo(
    ...
    [bold cyan]What this does:[/bold cyan]
      ...
      2. Initializes mcp-code-intelligence in the demo project
      3. Indexes the sample code
      4. Runs a sample semantic search
      5. Shows you the results

    [bold cyan]Examples:[/bold cyan]
      [green]mcp-code-intelligence demo[/green]
        Run full interactive demo

      [green]mcp-code-intelligence demo --quick[/green]
        Skip search demo, only show installation

      [green]mcp-code-intelligence demo --keep[/green]
...
'''
            ...
            # Run initialization
            print_info("🔧 Initializing mcp-code-intelligence in demo project...")
            ...
            console.print("  2. [green]mcp-code-intelligence init[/green]")
            console.print("  3. [green]mcp-code-intelligence search 'your query'[/green]\n")
