...
from mcp_code_intelligence.analysis.trends import TrendTracker
...
from mcp_code_intelligence.cli.commands.visualize.state_manager import VisualizationState
...
async def build_graph_data(
    ...
    dir_index_path = (
        project_manager.project_root / ".mcp-code-intelligence" / "directory_index.json"
    )
