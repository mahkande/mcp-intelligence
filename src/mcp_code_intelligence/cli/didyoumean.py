...
COMMAND_INFO = {
    "search": {
        ...
        "examples": [
            'mcp-code-intelligence search "authentication function"',
    ...
    "chat": {
        ...
        "examples": [
            ...
            'mcp-code-intelligence chat "how does authentication work?"',
            'mcp-code-intelligence chat --limit 3 "explain error handling"',
        ],
    ...
    "index": {
        ...
        "examples": [
            ...
            'mcp-code-intelligence index --include "*.py,*.js"',
        ],
        "related": ["auto-index", "watch", "reset"],
    },
    "status": {
        "description": "Show project status and statistics",
        "examples": ["mcp-code-intelligence status", "mcp-code-intelligence status --verbose"],
    ...
    "config": {
        ...
        "examples": [
            ...
            "mcp-code-intelligence config set model all-MiniLM-L6-v2",
        ],
        "related": ["init", "status"],
    },
    "init": {
        ...
        "examples": [
            ...
            "mcp-code-intelligence init --model sentence-transformers/all-MiniLM-L6-v2",
        ],
        "related": ["config", "install", "index"],
    },
    "mcp": {
        "description": "Manage Claude Code MCP integration",
        "examples": ["mcp-code-intelligence mcp", "mcp-code-intelligence mcp test"],
    ...
    "version": {
        ...
        "examples": ["mcp-code-intelligence version", "mcp-code-intelligence --version"],
...
def add_common_suggestions(ctx: click.Context, command_name: str) -> None:
    ...
    if direct_suggestion:
        ...
        if "--" not in direct_suggestion:  # Don't show examples for flags
            console.print(
                f"\n[dim]Try: [bold]mcp-code-intelligence {direct_suggestion}[/bold][/dim]"
            )
        return
