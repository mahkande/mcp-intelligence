            ...
            if claude_config.exists():
                try:
                    with open(claude_config) as f:
                        ...
                        state["has_mcp_config"] = "mcp-code-intelligence" in mcp_servers
        ...
        if failed_command:
            ...
            if suggestions:
                ...
                for i, suggestion in enumerate(suggestions[:3], 1):  # Show top 3
                    ...
                    self.console.print(
                        ...
                        f"[bold cyan]mcp-code-intelligence {suggestion['command']}[/bold cyan]"
                    )
            ...
            if next_steps:
                ...
                for i, step in enumerate(next_steps[:3], 1):
                    ...
                    self.console.print(
                        f"  [{priority_color}]{i}.[/{priority_color}] "
                        f"[bold cyan]mcp-code-intelligence {step['command']}[/bold cyan]"
                    )
